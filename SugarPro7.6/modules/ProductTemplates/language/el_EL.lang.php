...
$mod_strings = array (
  ...
  'LBL_NEW_FORM_TITLE' => 'Δημιουργία Στοιχείου',
  'LBL_PERCENTAGE' => 'Ποσοστό(%)',
  'LBL_POINTS' => 'Σημεία',
  'LBL_POINTS_ABBR' => 'Σημεία.',
  ...
  'LNK_IMPORT_PRODUCT_CATALOG'=>'Εισαγωγή Καταχωρήσεων Καταλόγου Προϊόντων',

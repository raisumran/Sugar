...
$mod_strings = array(
	...
	'ERR_UW_FILE_NOT_WRITABLE'					=> 'ファイルが移動されたか書き込みできません:',
	'ERR_UW_FLAVOR_2'							=> 'アップグレードフレーバー:',
	'ERR_UW_FLAVOR'								=> 'SugarCRMシステムフレーバー:',
	'ERR_UW_LOG_FILE_UNWRITABLE'				=> './upgradeWizard.logが作成（書き込み）できませんでした。SugarCRMインストールディレクトリのパーミッションを確認してください。',
	...
	'ERR_UW_OCI8_VERSION'				        => 'このOracleのバージョンはSugarではサポートしていません。Sugarアプリケーションと適合するバージョンをインストールする必要があります。サポートされているOracleのバージョンを確認するにはリリースノートのサポートプラットフォームを参照してください。現行バージョン:',
	...
	'ERR_UW_UPLOAD_ERR'							=> 'ファイルのアップロード中にエラーが見つかりました。<br />\\n',
	...
	'LBL_UW_CANCEL_DESC'						=> 'アップグレードウィザードは中止されました。  すべての一時ファイルとアップロードされたzipファイルは削除されます。<br><br>「完了」ボタンをクリックしてアップグレードウィザードを再度実行してください。',
	...
	'LBL_UW_END_DESC2'							=> 'ファイルのマージやSQLの実行で手作業を選択した場合、ここで実行してください。このステップが完了するまではシステムは不安定な状態になります。',
	'LBL_UW_END_LOGOUT_PRE'						=> 'アップグレードが完了しました。',
	'LBL_UW_END_LOGOUT_PRE2'					=> '完了をクリックしてアップグレードウィザードを終了してください。',
	...
	'LBL_UW_NEXT_TO_UPLOAD'						=> "<b>次へをクリックしてアップグレードパッケージをアップロードしてください。</b>",
	...
	'LBL_UW_OVERWRITE_DESC'						=> "あなたが作成したカスタマイズしたコードやテンプレートを含むすべての変更したファイルは上書きされました。本当に続行してよいですか？",
	'LBL_UW_OVERWRITE_FILES_CHOICE1'			=> 'すべてのファイルを上書き',
	'LBL_UW_OVERWRITE_FILES_CHOICE2'			=> 'マニュアルでマージ －すべてを維持',
	'LBL_UW_OVERWRITE_FILES'					=> 'マージの方法',
	'LBL_UW_PATCH_READY'						=> 'パッチを実行する準備ができました。「実行」ボタンをクリックするとアップグレードが開始されます。',
	...
	'LBL_UW_PREFLIGHT_FILES_DESC'				=> '以下のファイルが更新されています。手作業でのマージが必要なファイルはチェックをはずしてください。<i>レイアウトが変更されているファイルは自動的にチェックがはずれています。上書きしても良いファイルは再度チェックを入れてください。',
	'LBL_UW_PREFLIGHT_NO_DIFFS'					=> '手作業でのマージが必要なファイルはありません。',
	...
	'LBL_UW_PREFLIGHT_TESTS_PASSED2'			=> '次へをクリックしてアップグレードファイルをシステムにコピーしてください。',
	'LBL_UW_PREFLIGHT_TESTS_PASSED3'			=> '<b>注意: </b>残りのアップグレード処理は必須です。次へをクリックすると処理を完了させることができます。処理を中断するにはキャンセルボタンをクリックしてください。',
	...
	'LBL_UW_START_DESC3'						=> '次へをクリックすると、システムをチェックしアップグレードを実行して良いかどうかを確認します。チェック処理には、ファイルのパーミッション、データベース権限、サーバの設定の確認などが含まれます。',
	...
	'LBL_UW_CUSTOMIZED_OR_UPGRADED_MODULES'     => 'アップグレード済み/カスタマイズ済みモジュール',
	'LBL_UW_FOLLOWING_MODULES_CUSTOMIZED'       => 'カスタマイズされた以下のモジュールを検出し、保存しました。',
	'LBL_UW_FOLLOWING_MODULES_UPGRADED'         => 'スタジオでカスタマイズされた以下のモジュールを検出し、アップグレードしました。',
    ...
    'LBL_PREFLIGHT_FILE_COPYING_PROGRESS'       => 'ファイルのコピー中です',
	'LBL_COMMIT_UPGRADE_IN_PROGRESS'            => 'アップグレードの確定中です',
    'LBL_UW_COMMIT_DESC'						=> '次へをクリックすると追加のアップグレードスクリプトを実行します。',
	'LBL_UPGRADE_SCRIPTS_IN_PROGRESS'			=> 'アップグレードスクリプトの実行中です',
	'LBL_UPGRADE_SUMMARY_IN_PROGRESS'			=> 'アップグレードサマリの処理中です',
	'LBL_UPGRADE_IN_PROGRESS'                   => '処理中です',
	'LBL_UPGRADE_TIME_ELAPSED'                  => '経過時間',
	'LBL_UPGRADE_CANCEL_IN_PROGRESS'			=> 'アップグレードのキャンセルとロールバックです',
    'LBL_UPGRADE_TAKES_TIME_HAVE_PATIENCE'      => 'アップグレードには時間がかかる場合があります。',
    'LBL_UPLOADE_UPGRADE_IN_PROGRESS'           => 'アップロードのチェック中です',
	'LBL_UPLOADING_UPGRADE_PACKAGE'      		=> 'アップグレードパッケージをアップロード中です',
    'LBL_UW_DORP_THE_OLD_SCHMEA' 				=> '古い4.5.1のスキーマを削除してよいですか？',
	...
	'LBL_UW_SHOW_OLD_SCHEMA_TO_DROP'			=> 'ドロップ可能な旧スキーマを表示',
	'LBL_UW_SKIPPED_QUERIES_ALREADY_EXIST'      => 'スキップされたクエリ',
	...
	'LBL_MODULE_NAME_SINGULAR' => 'アップグレードウィザード',
	'LBL_UPLOAD_SUCCESS' => 'アップグレードパッケージがアップロードされました。次へをクリックして最終チェックに進んでください。',
	...
	'LBL_LAYOUT_MERGE_TITLE' => '次へをクリックするとレイアウトを確認し、アップグレードを完了します。',
	'LBL_LAYOUT_MERGE_TITLE2' => '次へをクリックしてアップグレードを完了してください。',
	...
	'LBL_LANGPACKS' => '言語ファイル' /*for 508 compliance fix*/,
	'LBL_MODULELOADER' => 'モジュールローダー' /*for 508 compliance fix*/,
	'LBL_PATCHUPGRADES' => 'パッチアップグレード' /*for 508 compliance fix*/,

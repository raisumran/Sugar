...
'LBL_SUGAR_FIELDS_STAGE' => 'Champs Sugar (cliquer sur les éléments à ajouter dans la zone de dépot)',
'LBL_SUGAR_BIN_STAGE' => 'Poubelle Sugar (cliquer sur les éléments à ajouter dans la zone de dépot)',
'LBL_VIEW_SUGAR_FIELDS' => 'Voir les champs Sugar',
'LBL_VIEW_SUGAR_BIN' => 'Voir la poubelle Sugar',
...
//SUGAR PORTAL
'LBL_SW_SUGARPORTAL'=>'Portail Sugar',
'LBL_SMP_WELCOME'=>'Merci de sélectionner le module que vous voulez éditer dans la liste suivante',
'LBL_SP_WELCOME'=>'Bienvenu dans le Studio du Portail Sugar. Vous pouvez choisir, soit d&#39;éditer des modules soit synchroniser vers une instance de portail. <br>Merci de choisir à partir de la liste ci-dessous.',
'LBL_SP_SYNC'=>'Synchro portail',
'LBL_SYNCP_WELCOME'=>'Merci de choisir l&#39;url de l&#39;instance du portail à mettre à jour et d&#39;appuyer ensuite sur le bouton Go.<br> Entrez ensuite votre login et votre mot de passe Sugar dans le prompt qui va apparaître et appuyez sur le bouton afin de commencer la synchronisation.',

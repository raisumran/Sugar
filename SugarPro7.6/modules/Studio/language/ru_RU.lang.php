...
'LBL_SMA_EDIT_CUSTOMFIELDS'=>'Правка индивидуальных полей',
...
'LBL_SP_PREVIEW'=>'Предварительный просмотр результата  форматирования с применением указанной таблицы стилей.',
	...
	'LBL_UNDO' => 'Отмена' /*for 508 compliance fix*/,
	'LBL_REDO' => 'Повторное выполнение' /*for 508 compliance fix*/,
	'LBL_INLINE' => 'Встроенный' /*for 508 compliance fix*/,
	'LBL_DELETE' => 'Удалить' /*for 508 compliance fix*/,
	'LBL_ADD_FIELD' => 'Добавить поле' /*for 508 compliance fix*/,
	'LBL_MAXIMIZE' => 'Увеличить' /*for 508 compliance fix*/,
	'LBL_MINIMIZE' => 'Уменьшить' /*for 508 compliance fix*/,

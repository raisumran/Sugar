...
'LBL_MB_WELCOME'=> '<h2>Historial</h2><br> El Historial le permite ver ediciones publicadas anteriormente del fichero con el que actualmente está trabajando. Puede comparar con y restaurar versiones previas. Si restaura un archivo, éste se convertirá en su archivo de trabajo. Debe publicarlo antes de que sea visible para cualquier otra persona.<br> ¿Qué desea hacer hoy?<br><b> Por favor, seleccione una de las siguientes opciones.</b>',
...
'LBL_MODULE_NAME' => 'Motor de Expresiones',
'LBL_MODULE_NAME_SINGULAR' => 'Motor de Expresiones',
...
'LBL_LISTVIEWP_DESCRIPTION'=>'Tiene dos columnas a continuación: Por defecto, que incluye los campos que se mostrarán, y Disponible, que incluye los campos que no se mostrarán, pero que están disponibles para ser mostrados. Simplemente tiene que arrastrar los campos entre ambas columnas. También puede cambiar el orden de los elementos en una columna arrastrándolos y soltándolos.',
'LBL_SP_STYLESHEET'=>'Subir una Hoja de Estilo',
'LBL_SP_UPLOADSTYLE'=>'Haga clic en el botón de exploración y seleccione la hoja de estilo que desea subir de su ordenador.<br> La próxima vez que realice una sincronización al portal, se incluirá la hoja de estilos.',

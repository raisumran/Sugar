...
$mod_strings = array (
  ...
  'LBL_ACCOUNT_NAME' => 'Организация',
    ...
    'LBL_URL' => 'Стартирай/Включи се в срещата',
    'LBL_HOST_URL' => 'URL на хоста',
    'LBL_DISPLAYED_URL' => 'Покажи URL',
    'LBL_CREATOR' => 'Автор на срещата',
    'LBL_EXTERNALID' => 'Идентификатор на външното приложение',
	'LBL_SUBJECT' => 'Относно:',
    ...
    'LBL_MEETING_INFORMATION' => 'Задача',
	'LBL_LIST_JOIN_MEETING' => 'Присъедини се към срещата',
	'LBL_JOIN_EXT_MEETING' => 'Присъедини се към срещата',
	'LBL_HOST_EXT_MEETING' => 'Започни среща',
    'LBL_JOIN_MEETING' => 'Включи се в {{meetingType}}',
    'LBL_START_MEETING' => 'Започни {{meetingType}}',
    'LBL_ACCEPT_STATUS' => 'Статус на поканата',
    'LBL_ACCEPT_LINK' => 'Приеми връзката',
    'LBL_ERROR_LAUNCH_MEETING_GENERAL' => 'Възникна грешка при инициирането на тази среща. Моля свържете се със Администратор.',
  ...
  //For export labels
    'LBL_EXPORT_JOIN_URL' => 'Url за достъп до срещата',
    'LBL_EXPORT_HOST_URL' => 'Url на хоста',
    'LBL_EXPORT_DISPLAYED_URL' => 'Визуализиран Url',
    ...
    'LBL_EXPORT_PARENT_ID' => 'Родителски идентификатор',
    'LBL_EXPORT_REMINDER_TIME' =>'Напомняне преди срещата (в минути)',
    ...
    'LBL_CREATE_MODULE' => 'Насрочване на среща',
    'LBL_RELATED_RECORD_DEFAULT_NAME' => 'Среща с {{{this}}}',
    'LBL_SEND_INVITES' => 'Изпращане на покани',
    'LBL_REMINDER_TITLE' => 'Среща:',

    'LBL_REVENUELINEITEMS' => 'Приходни позиции',

    'LBL_MEETING_CLOSE_SUCCESS' => 'Срещата е проведена успешно.',

    //record save
    'LBL_RECORD_SAVED_SUCCESS' => 'Вие насрочихте {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{name}}</a> за {{formatDate date_start}}.',
    'LBL_RECORD_SAVED_ACCESS_DENIED' => 'Вие насрочихте {{moduleSingularLower}} за {{formatDate date_start}}, но не разполагате с права да я досдъпите.',

    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} съдържа записи за срещи, които могат да бъдат със статус "Планирана", "Проведена" или "Несъстояла се". Предстоящите е следващите 24 часа срещи са оцветени в синьо. Просрочените обаждания  са оцветени в червено. От списъка със записи на модул {{plural_module_name}}можете да разглеждате и редактирате информация за отделните срещи. Допълнителни действия могат да бъдат предприемани през менюто в края на всеки от редовете. За да маркирате среща като "Проведена" можете да използвате опцията „Затвори“ за всяка от планираните срещи. Потребители, контакти и потенциални клиенти могат да бъдат канени като участници в отделните срещи. {{plural_module_name}} могат да бъдат създавани през модул {{plural_module_name}}, Календара на системата или да бъдат импортирани. За създаване може да се използва и панелът Дейности (за конвенционални модули ) или панелът Планирани дейности (за Sidecar модули) на свързани модули (например Контакти, Организации и др.), при което ще бъде създадена и  връзка между двата записа.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} се състои от {{meetings_singular_module}} проведени от служители на вашата организация. {{plural_module_name}}те могат да бъдат със статус "Планирана", "Проведена" или "Несъстояла се". Потребители на Sugar, както и {{contacts_module}} и {leads_module}}могат да бъдат канени като участници. - Редактирайте полетата на този запис като маркирате с мишката конкретно поле или като използвате бутона Редактирай. - Можете да разгледате или да модифицирате връзки към други записи през панелите със свързани записи, като превключите долната лява секция на екрана в режим „Свързани записи“. - Можете да разгледате историята на промените по записа и коментарите на потребителите, както и вие да направите такива като превключите долната лява секция на екрана в режим „Хронология“. - Следвайте или маркирайте този запис като любим чрез иконите в дясно от името на записа. - Допълнителни действия  са възможни през падащото меню в дясно от бутона Редактирай.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} се състои от {{plural_module_name}} проведени от служители на вашата организация. {{plural_module_name}}те могат да бъдат със статус "Планирана", "Проведена" или "Несъстояла се". Потребители на Sugar, както и {{contacts_module}} и {leads_module}}могат да бъдат канени като участници. За да създадете {{meetings_singular_module}}: 1. Задайте желаните от вас стойности на полетата. - Полетата маркирани като "Задължителни" трябва да бъдат попълнени преди да запазите записа. - Натиснете "Покажи повече", за да визуализирате допълнителни полета ако е необходимо. 2. Добавете участници в {{meetings_singular_module}}то. - Натиснете "Изберете участник", за да добавите съществуващ потребител, контакт или потенциален клиент към {{meetings_singular_module}}то. - Натиснете бутона „плюс“ в дясно от „Изберете участник“, за да създадете участник в {{meetings_singular_module}}то като нов запис в  Sugar. 3. Натиснете "Съхрани", за да запазите новия запис и да се върнете на предишната страница. - Изберете "Съхрани и разгледай", за да отворите новото {{meetings_singular_module}}. - Изберете "Съхрани и създай нов запис", за да създадете веднага още едно допълнително {{meetings_singular_module}}.',
);

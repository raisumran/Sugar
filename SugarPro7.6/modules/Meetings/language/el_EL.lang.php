...
$mod_strings = array (
  ...
  'LBL_ACCOUNT_NAME' => 'Λογαριασμός',
	...
	'LBL_REMINDER_EMAIL' => 'Οποιοδήποτε Email',
    ...
    'LBL_JOIN_MEETING' => 'Συμμετοχή {{meetingType}}',
    'LBL_START_MEETING' => 'Έναρξη {{meetingType}}',
    'LBL_ACCEPT_STATUS' => 'Αποδοχή Κατάστασης',
    'LBL_ACCEPT_LINK' => 'Αποδοχή Συνδέσμου',
    'LBL_ERROR_LAUNCH_MEETING_GENERAL' => 'Παρουσιάστηκε σφάλμα κατά την έναρξη αυτής της συνεδρίασης. Επικοινωνήστε με το Διαχειριστή σας.',
  ...
  //For export labels
    ...
    'LBL_RECORD_SAVED_ACCESS_DENIED' => 'Προγραμματίσατε το {{moduleSingularLower}} για {{formatDate date_start}}, αλλά δεν έχετε δικαίωμα πρόσβασης σε αυτό.',

    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η {{plural_module_name}} ενότητα, αποτελείται από εγγραφές {{meetings_singular_module}}, οι οποίες καταχωρούνται από τους χειριστές του οργανισμού σας. Η ενότητα {{plural_module_name}}, μπορεί να είναι σε κατάσταση "Προγραμματισμένη", "Πραγματοποιήθηκε" ή "Ακυρώθηκε". Από αυτή την ενότητα {{plural_module_name}} προβολή λίστας, μπορείτε να κάνετε κλικ στο κουμπί δράσης σε κάθε προγραμματισμένη {{meetings_singular_module}} ενέργεια, προκειμένου να επισημάνει ότι πραγματοποιήθηκε. Οι χειριστές του Sugar καθώς και {{contacts_module}} και {{leads_module}} μπορούν να προστεθούν ως προσκεκλημένοι. Υπάρχουν διάφοροι τρόποι που μπορείτε να δημιουργήσετε {{meetings_module}} στο Sugar, όπως μέσω της ενότητας {{plural_module_name}}, {{calendar_module}} ενότητα, εισαγωγή {{meetings_module}}, κλπ. Οι χρήστες μπορούν να χρονοπρογραμματίσουν επίσης {{meetings_module}} μέσω του υποπίνακα δραστηριοτήτων (για την Κληρονομιά Ενότητες) ή στον Πίνακα Στοιχείων Αρχικής Σελίδας να προγραμματίσουν δραστηριότητες (για τις ενότητες Sidecar) σε συναφή ενότητες (e.g. {{contacts_module}}, {{accounts_module}}, {{leads_module}}, κ.α.) που δημιουργεί αυτόματα μια σχέση μεταξύ των δύο εγγραφών. Αφού δημιουργηθεί η εγγραφή {{meetings_singular_module}}, μπορείτε να προβάλετε και να επεξεργαστείτε τις πληροφορίες που την αφορούν στο {{meetings_singular_module}} μέσω της ενότητας {{module_name}} προβολή των λεπτομερειών.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η {{plural_module_name}} ενότητα, αποτελείται από εγγραφές {{meetings_singular_module}}, οι οποίες καταχωρούνται από τους χειριστές του οργανισμού σας. Η ενότητα {{plural_module_name}}, μπορεί να είναι σε κατάσταση "Προγραμματισμένη", "Πραγματοποιήθηκε" ή "Ακυρώθηκε". Οι χειριστές του Sugar {{contacts_module}} και {{leads_module}} μπορούν να προστεθούν ως προσκεκλημένοι.
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η {{plural_module_name}} ενότητα, αποτελείται από εγγραφές {{meetings_module}}, οι οποίες καταχωρούνται από τους χειριστές του οργανισμού σας. Η ενότητα {{plural_module_name}}, μπορεί να είναι σε κατάσταση "Προγραμματισμένη", "Πραγματοποιήθηκε" ή "Ακυρώθηκε". Οι χειριστές του Sugar {{contacts_module}} και {{leads_module}} μπορούν να προστεθούν ως προσκεκλημένοι.

Για να δημιουργήσετε μία {{module_name}}:
1. Παρέχετε τιμές για τα πεδία, όπως επιθυμείτε.
 - Τα Πεδία με σήμανση "Υποχρεωτικά", πρέπει να ολοκληρωθούν πριν από την αποθήκευση.
 - Κάντε κλικ στην επιλογή "Εμφάνιση Περισσότερων" να εκθέσει πρόσθετα πεδία, εάν είναι απαραίτητο.
2. Προσθέστε προσκεκλημένους στην ενότητα {{meetings_singular_module}}.
 - Κάντε κλικ στο "Επιλέξτε ένα Συμμετέχοντα" για να προσθέσετε έναν υπάρχον χρήστη, επαφή, ή δυνητικό πελάτη στην ενότητα {{meetings_singular_module}}.
 - Κάντε κλικ στο συν εικονίδιο στα δεξιά του "Επιλέξτε ένα Συμμετέχοντα", για να δημιουργήσετε ένα συμμετέχοντα στην ενότητα {{meetings_singular_module}} ως νέα εγγραφή στο Sugar.
3. Κάντε κλικ στο κουμπί "Αποθήκευση" να οριστικοποιήσουν οι νέες εγγραφές και να επιστρέψετε στην προηγούμενη σελίδα. - Επιλέξτε "Αποθήκευση και προβολή" για την προβολή της νέας  εγγραφής της συνάντησης. - Επιλέξτε "Αποθήκευση και δημιουργία νέας" για να δημιουργήσετε αμέσως μία νέα συνάντηση {{meetings_singular_module}}.',
);

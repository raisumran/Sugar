...
$mod_strings = array(
    ...
    'LNK_NEW_REVENUELINEITEM' => 'Създай приходна позиция',
    ...
    'LBL_ASSIGNED_USER_ID' => 'Отговорник (ID)',
    ...
    'LBL_ASSIGNED_TO_ID'=>'Отговорник (ID)',
    ...
    'LBL_CONVERT_INVALID_RLI' => 'Един или повече от избраните приходни позиции не могат да бъдат преобразувани в оферта:',
    ...
    'LBL_CONVERT_INVALID_RLI_ALREADYQUOTED_PLURAL' => 'Една или повече от маркираните приходни позиции са вече оферирани.',
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} съдържа записи за продукти, които са предмет на водени търговски преговори и са асоциирани с {{opportunities_singular_module}}. Всяка {{opportunities_singular_module}} може да обединява един или повече записи за приходни позиции.

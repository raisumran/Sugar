...
$mod_strings = array (
  ...
  'LBL_TEAM_NOTICE_FEATURES' => '機能:<br />* ユーザインタフェースが改善され、新しいウィザードはユーザがレポートを作成するためにガイドつきの簡単でわかりやすいデザインになりました。<br />* ユーザが複雑なロジックを用いて複数のモジュールにまたがったレポートを作成することができます。<br />* マトリックスレポートは柔軟性のあるグリッドレイアウト上で複数の属性でグルーピングすることができます。ユーザは総和/平均/カウント/百分率といったオペレーションを行いつつ複雑なピボットテーブルを作成することができます。<br />* 実行時フィルタはリアルタイムにレポートの属性を変更することができます。',

...
'help'=>array(
    ...
    'fieldsEditor'=>array(
        ...
        'mbeditField' => 'The <b>Display Label</b> of a template field can be customised. The other properties of the field can not be customised.<br><br>Click <b>Clone</b> to create a new field with the same properties.<br><br>To remove a template field so that it does not display in the module, remove the field from the appropriate <b>Layouts</b>.'
...
'LBL_INDICATES_COMBO_FIELD' => '** Indicates a combination field. A combination field is a collection of individual fields. For example, "Address" is a combination field that contains "Street address", "City", "County", "Post Code and "Country".<br><br>Doubleclick a combination field to see which fields it contains.',

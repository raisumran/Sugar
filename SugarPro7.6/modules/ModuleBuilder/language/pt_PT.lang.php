...
'LBL_SELECT_FILE'=> 'Seleccionar um Ficheiro',
...
'LBL_TABDEF_TYPE_HELP' => 'Seleccione a forma como esta secção será exibida. Esta opção apenas terá efeito se activou tabuladores nesta tela.',
'LBL_TABDEF_TYPE_OPTION_TAB' => 'Tabulador',
'LBL_TABDEF_TYPE_OPTION_PANEL' => 'Painel',
'LBL_TABDEF_TYPE_OPTION_HELP' => 'Seleccione Painel para ter este painel exibido na tela de layout. Seleccione Tabulador para ter este painel exibido num tabulador dentro do layout. Quanto for especificado Tabulador para um painel, painéis subsequentes também serão exibidos no tabulador<br/>Por cada painel para o qual for escolhido Tabulador será criado um novo tabulador. Se tabulador for seleccionado para um painel abaixo do primeiro, o primeiro será necessariamente um tabulador.',
...
'LBL_PORTAL_ROLE_DESC' => 'Não apagar este role. O Role de Cliente de Self-Service do Portal é um role gerado pelo sistema durante a activação do Sugar Portal. Use controlos de Acesso dentro deste Role para activar e/ou desactivar os módulos de Bugs, Ocorrências ou Base de Conhecimento no Sugar Portal. Não modificar  outros controlos de acesso para este role para evitar comportamentos desconhecidos e imprevisíveis do sistema. Em caso de uma eliminação acidental deste role, poderá cria-lo de novo desactivando e activando o Sugar Portal.',
...
//SUGAR PORTAL
    'LBL_PORTAL_DISABLED_MODULES' => 'O(s) seguinte(s) módulo(s) esta(ão) desactivado(s):',
...
'LBL_LABEL'=>'Etiqueta para Plural',
'LBL_LABEL_TITLE'=>'Etiqueta',
'LBL_SINGULAR_LABEL' => 'Etiqueta para Singular',
'LBL_WIDTH'=>'Largura',
'LBL_PACKAGE'=>'Pacote:',
'LBL_TYPE'=>'Tipo:',
...
'LBL_POPHELP_SEARCHABLE'=>'Tem que efectuar uma indexação completa do sistema depois de mudar o nível de reforço.',

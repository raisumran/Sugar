...
$mod_strings = array (
  ...
  'NTC_REMOVE_TRIGGER_PRIMARY' => 'Remover um trigger primário irá remover todos os triggers.',
...
//Specific Lables
  ...
  'LBL_PAST_TRIGGER' => 'Especificar antigo',
 	...
 	'LBL_NEW_FILTER_BUTTON_LABEL' => 'Criar Filtro [Alt+F]',

  	'LBL_NEW_TRIGGER_BUTTON_KEY' => 'T',
 	'LBL_NEW_TRIGGER_BUTTON_TITLE' => 'Criar Triggers',
 	'LBL_NEW_TRIGGER_BUTTON_LABEL' => 'Criar Triggers',
	...
	'LBL_SELECT_TARGET_FIELD' => 'Por favor seleccione um campo de destino.',
	'LBL_SELECT_TARGET_MOD' => 'Por favor seleccione um módulo relacionado com o destino.',
	'LBL_SPECIFIC_FIELD_LNK' => 'campo específico',
	'LBL_MUST_SELECT_VALUE' => 'Deve seleccionar um valor para este campo',
	
	'LBL_SELECT_AMOUNT' => 'Deve seleccionar o montante',
	'LBL_SELECT_1ST_FILTER' => 'Deve seleccionar um campo de primeiro filtro válido',
	'LBL_SELECT_2ND_FILTER' => 'Deve seleccionar um campo de segundo filtro',

	'ERR_DELETE_RECORD' => 'Um número de registo deve ser especificado para eliminar este registo.',
	'ERR_DELETE_EMPTY' => 'O registo já foi apagado ou não existe.',

...
//Specific Lables
  ...
  'LBL_PAST_TRIGGER' => '古い値を指定',
 	...
 	'LBL_NEW_FILTER_BUTTON_LABEL' => 'フィルタ作成[Alt+F]',

  	'LBL_NEW_TRIGGER_BUTTON_KEY' => 'T',
 	'LBL_NEW_TRIGGER_BUTTON_TITLE' => 'トリガー作成',
	...
	'ERR_DELETE_RECORD' => 'レコードを削除するにはレコード番号を指定する必要があります。',
	'ERR_DELETE_EMPTY' => 'レコードは既に削除されたか存在しません。',

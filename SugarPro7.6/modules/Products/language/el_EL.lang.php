...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME' => 'Γραμμή Εισηγμένων Ειδών',
    'LBL_MODULE_NAME_SINGULAR' => 'Γραμμή Εισηγμένων Ειδών',
    ...
    'LBL_RELATED_PRODUCTS' => 'Σχετίζεται με Γραμμή Εισηγμένων Στοιχείων',
    'LBL_LEAD_SOURCE' => 'Πηγή Προέλευσης',
    'LBL_LIST_NAME' => 'Γραμμή Εισηγμένων Ειδών',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Γραμμή Εισηγμένων Ειδών',
    'LBL_RELATED_PRODUCTS_TITLE' => 'Γραμμή Εισηγμένων Ειδών',
    ...
    'LBL_REVENUELINEITEM' => 'Γραμμή Εσόδων', 
    ...
    'LNK_IMPORT_PRODUCTS' => 'Εισαγωγή Εισηγμένων Ειδών',

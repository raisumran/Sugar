...
//END DON'T CONVERT
    ...
    'LNK_OPPORTUNITY_REPORTS' => 'Переглянути звіти по угодам',
...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{Plural_module_name}} модуль дозволяє вам відстежувати окремі продажу і позиції, які стосуються тем збуту, від початку і до кінця. Кожен {{module_name}} запис являє собою назву для групи {{revenuelineitems_module}} і відноситься до інших важливих записів, таким як {{quotes_module}}, {{contacts_module}}, і т.п. Кожен {{revenuelineitems_singular_module}} є перспективною угодою на певний товар і містить релевантні дані з продажу. Кожен {{revenuelineitems_singular_module}} буде проходити кілька Стадій Продажів до тих пір, поки не набуде статусу "Успішно Закрита" або "Програно". {{Module_name}} запис відображає суму і передбачувану дату закриття {{revenuelineitems_module}}. {{Plural_module_name}} і {{revenuelineitems_module}} можуть бути використані більш вигідно за допомогою Sugar {{forecasts_singular_module}} модуля для розуміння і прогнозування тенденцій продажів, і зосередження роботи на досягненні встановлених квот.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{Plural_module_name}} модуль дозволяє вам відстежувати окремі продажі і позиції, які стосуються тем збуту, від початку і до кінця. Кожен {{module_name}} запис являє собою назву для групи {{revenuelineitems_module}} і відноситься до інших важливих записів, таких як {{quotes_module}}, {{contacts_module}}, і т.п.

- Щоб редагувати поля даного запису, натисніть на самому полі або клікніть на кнопку Редагувати.
- Щоб переглянути або змінити посилання, що ведуть до інших записів, на субпанелі, включаючи {{revenuelineitems_module}}, перейдіть на ліву нижню панель  "Перегляд даних".
- Щоб залишати і переглядати коментарі користувача, а також змінювати історію в рамках одного запису в {{activitystream_singular_module}} перемкніть ліву нижню панель на "Стрічка активності".
...
- Додаткові дії доступні у випадаючому меню Дій праворуч від кнопки Редагувати.',
    ...
    'LBL_HELP_CREATE' => '{{Plural_module_name}} модуль дозволяє вам відстежувати окремі продажі і позиції, які стосуються тем збуту, від початку і до кінця. Кожен {{module_name}} запис являє собою назву для групи {{revenuelineitems_module}} і відноситься до інших важливих записів, таких як {{quotes_module}}, {{contacts_module}}, і т.п.
...
3. Після збереження, використовуйте {{revenuelineitems_module}} субпанель, щоб додати позиції продажів в {{module_name}}.',

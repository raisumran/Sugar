...
$mod_strings = array (
  ...
  'LBL_TPL_PRODUCT' => 'Продукт коммерческого предложения',
  'LBL_TPL_RLI' => 'Доход по продуктам',
  'LBL_TPL_LIST_PRICE' => 'Цена по списку',
  'LBL_TPL_UNIT_PRICE' => 'Цена за единицу',
  'LBL_TPL_EXT_PRICE' => 'Внешняя цена',
  'LBL_TPL_SUBTOTAL' => 'Общая сумма:',
  'LBL_TPL_DISCOUNT' => 'Скидка:',
  'LBL_TPL_DISCOUNTED_SUBTOTAL' => 'Общая сумма со скидкой:',
  'LBL_TPL_TAX' => 'Налог:',
  'LBL_TPL_SHIPPING' => 'Стоимость доставки:',
  'LBL_TPL_TOTAL' => 'Итого',
  'LBL_TPL_GRAND_TOTAL' => 'Итого',
  'LBL_TPL_CURRENCY' => 'Валюта',
  'LBL_TPL_TAX_RATE' => 'Налоговая ставка:',
  'LBL_TPL_SHIPPING_PROVIDER' => 'Служба доставки:',

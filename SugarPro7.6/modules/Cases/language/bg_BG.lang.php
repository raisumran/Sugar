...
$mod_strings = array (
	...
	'LBL_LIST_LAST_MODIFIED'			=> 'Последно модифицирана',
	...
	'LBL_LIST_DATE_CREATED'			=> 'Въведено на',
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} се използва за проследяване и управление на повдигнати казуси, свързани с предоставяните стоки или услуги.

...
$mod_strings = array(
    ...
    'LBL_SNIP_SUMMARY' => "E-mail arkivering er en automatisk import service, der giver brugerne mulighed for at importere e-mails til Sugar ved at sende dem fra enhver mail-klient eller service til en fra Sugar angivet e-mail-adresse. Hver Sugar instans har sin egen unikke e-mail-adresse. For at importere e-mails, sender brugeren mails til den medfølgende e-mail-adresse ved hjælp af Til, Cc og Bcc felterne. E-mail arkiveringsservicen importerer så modtagne e-mails til Sugar instansen. Servicen importerer e-mails, sammen med eventuelle vedhæftede filer, billeder og kalenderoplysninger og opretter poster i applikationen, der er forbundet med eksisterende poster baseret på matchende e-mail adresser.<br /><br />Eksempel: Som bruger, når jeg får vist en konto, være i stand til at se alle de e-mails, der er forbundet med kontoen baseret på e-mail-adressen i konto posten. Jeg vil også kunne se e-mails, der er forbundet med kontaktpersoner relateret til kontoen.<br /><br />Accepter vilkårene nedenfor og klik på Aktiver for at begynde at bruge servicen. Du kan deaktivere tjenesten til enhver tid. Når tjenesten er aktiveret, vises e-mailadressen der bruges af servicen.",
	'LBL_REGISTER_SNIP_FAIL' => 'Kunne ikke kontakte e-mail arkiveringsservicen: %s',
    ...
    'LBL_SNIP_AGREE' => "Jeg accepterer ovenstående betingelser og <a href=&#39;http://www.sugarcrm.com/crm/TRUSTe/privacy.html&#39; target=&#39;_blank&#39;>vilkår</a>.",

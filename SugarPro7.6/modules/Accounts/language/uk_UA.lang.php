...
$mod_strings = array (
	...
	'LNK_ACCOUNT_REPORTS' => 'Переглянути звіти по контрагентам',
	...
	'LBL_BUG_FORM_TITLE' => 'Контрагенти',
	...
	'LBL_PUSH_CONTACTS_BUTTON_LABEL' => 'Копіювати до контактів',
	'LBL_PUSH_CONTACTS_BUTTON_TITLE' => 'Копіювати...',
	...
	'LNK_CREATE' => 'Створити компанію',
	'LNK_ACCOUNT_LIST' => 'Переглянути контрагенти',
	'LNK_NEW_ACCOUNT' => 'Створити контрагент',
	'LNK_IMPORT_ACCOUNTS' => 'Імпорт контрагентів',
	'MSG_DUPLICATE' => 'Створюваний Вами контрагент можливо дублює вже наявний запис. Схожі контрагенти показані нижче. Натисніть кнопку "Зберегти" для продовження створення нового контрагента або кнопку "Відмовитися" для повернення в модуль.',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{Plural_module_name}} модуль містить перелік компаній, з якими взаємодіє Ваша організація, і є вузлом, де Ви можете управляти і аналізувати Ваші активності з клієнтами. Існує безліч способів, за допомогою яких Ви можете створити {{plural_module_name}} в Sugar, це можливо через {{plural_module_name}} модуль, дублювання, імпорт {{plural_module_name}}, і т.п. Як тільки {{module_name}} створено запис, Ви можете переглянути та редагувати інформацію, що стосується {{module_name}} в {{plural_module_name}} режимі перегляду запису. Кожен {{module_name}} запис може бути пов&#39;язаний з іншою записом Sugar, такий як {{contacts_module}}, {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, і багатьма іншими записами в процесі розвитку відносин з клієнтами.',
...
- Додаткові дії доступні у випадаючому меню Дій праворуч від кнопки Редагувати.',
    ...
    'LBL_HELP_CREATE' => '{{Plural_module_name}} модуль містить перелік компаній, з якими взаємодіє Ваша організація, і є вузлом, де Ви можете управляти і аналізувати Ваші активності з клієнтами
...
- Виберіть "Зберегти і створити", щоб відразу створити новий {{module_name}}.',
    ...
    'LBL_FILTER_ACCOUNTS_REPORTS' => 'Звіти по контрагентам',
);

...
$mod_strings = array (
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} 모듈은 조직 관계를 가지고 있으며, 일반적으로 관리하고 각 고객과 비즈니스 &#39;의 상호 작용을 분석하는 허브로 볼 수 있습니다 누구와 함께 회사로 구성되어 있습니다.만들려면 {{모듈 _}} :. 1 원하는 필드의 값을 제공합니다. - 필드는 "필수"로 표시하기 전에 저장을 완료해야합니다. - 필요한 경우 추가 필드를 노출 "더보기"를 클릭합니다. 2. 새 레코드를 완료하고 이전 페이지로 돌아갑니다 "저장"을 클릭합니다. - 선택 "저장 및보기"레코드보기에 {} {모듈 _} 새를 엽니 다. - 선택 "저장 및 새로 작성"바로 또 다른 새로운 만들 수 {{모듈 _}}을.',

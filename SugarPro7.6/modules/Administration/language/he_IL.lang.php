...
$mod_strings = array (
    ...
    'LBL_CONFIGURE_TABS_AND_SUBPANELS' => 'Drag and Drop the module names below to set their tabs as either as displayed or hidden. If you want to prevent non-admin users from displaying or hiding tabs uncheck the "Allow users to hide tabs" checkbox',
    'LBL_CONFIGURE_UPDATER'=>'Configure Sugar Updates',
    'LBL_CONTRACT_TITLE'=>'חוזים',
    ...
    'LBL_LICENSE_EXPIRE_DATE'   => 'תאריך תפוגה',
    ...
    'LBL_MANAGE_CONTRACTEMPLATES_TITLE'=>'סוגי חוזים',
    ...
    'LBL_MANAGE_TIMEPERIODS_TITLE' => 'משכי זמן',
    ...
    'LBL_PASSWORD_TEMPLATE' => 'תבניות דואר אלקטרוני',
    ...
    'LBL_PRODUCT_CATEGORIES_TITLE' => 'קטגוריית מוצרים',
    'LBL_PRODUCT_CATEGORIES' => 'Update the list of product categories',
    'LBL_PRODUCT_TYPES_TITLE' => 'סוגי מוצרים',
...
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_DATABASE_EXPORT' => "ייצוא",
    ...
    'LBL_SHIPPERS_TITLE' => 'חברות שילוח',
    ...
    'LBL_SUGAR_SCHEDULER_TITLE' => 'תזמן:',
    ...
    'LBL_UPDATE_TIMEZONE_PREVIEW'=>'תצוגה מקדימה',
    ...
    'LBL_UPGRADE_FIELDS_ADDING_COLUMN'=> 'מוסיף עמודה {0} ל',
    'LBL_UPGRADE_FIELDS_EXECUTE_NON_SIM_MODE'=> 'בצע מצב שאינו סימולציה',
    ...
    'LBL_UPGRADE_FIELDS_SCANNING'=> 'סורק',
    ...
    'LBL_WIRELESS_MODULES_ENABLE_DESC' => 'Select modules to appear in Sugar view in mobile devices',
    ...
    'LBL_HISTORY_CONTACTS_EMAILS_DESC' => 'אפשר/אל תאפשר מיילים מרשימת אנשי קשר קשורים לצפיה בלוח מחוונים משני של מיילים',
    ...
    'LBL_UW_ROLE_MATCHES_BY' => '(מתאים ב {0})',
    'LBL_UW_ROLE_MATCHES_BY_DELIMITER' => 'ו',
    'LBL_UW_DO_NOT_MAP_ROLE' => '--אין למפות תפקיד זה--',
...
'ML_CONFIG_OVERRIDE'=>'Config modification is not allowed',
   ...
   'LBL_EAPM_SETTINGS' => 'חשבונות חיצוניים',
   ...
   'LBL_MI_UN_ACTIONVIEWMAP' => 'Unninstalling Action View Map',
    ...
    'LBL_SNIP_TITLE' => 'ארכיון דואר אלקטרוני',
    ...
    'LBL_DIAGNOSTICS_VARDEFS_TYPE' => 'סוג:',
    'LBL_DIAGNOSTICS_VARDEFS_LENGTH' => 'Length',
    'LBL_DIAGNOSTICS_VARDEFS_REQUIRED' => 'חובה',

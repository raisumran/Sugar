...
$mod_strings = array (
  ...
  'LBL_PROSPECTS_SUBPANEL_TITLE'=>'목표고객 목록',
  ...
  'LBL_LIST_PROSPECTLIST_NAME'=>'이름',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{}} 모듈 _ 이름은 당신이 대량 마케팅 {{campaigns_singular_module}}에 포함 또는 제외 할 개인이나 조직의 모음으로 구성되어 있습니다. {{accounts_module}} {{plural_module_name}} {{contacts_module}}, 대상의 수와 어떤 조합을 포함 할 수 있습니다 {{leads_module}}, 사용자 및. 대상은 연령대, 지리적 위치, 또는 지출 습관으로 미리 정해진 일련의 기준에 따라 {{모듈 _}}로 그룹화 할 수 있습니다. {{}} plural_module_name 대량 이메일 마케팅에서 사용되는 {{campaigns_module는}}이 {{campaigns_module}} 모듈을 구성 할 수 있습니다.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{}} 모듈 _ 이름은 당신이 대량 마케팅 {{campaigns_singular_module}}에 포함 또는 제외 할 개인이나 조직의 모음으로 구성되어 있습니다. - 개인 필드 또는 편집 버튼을 클릭하여이 레코드의 필드를 편집합니다. -보기 또는 아래 왼쪽 창에 "데이터보기"를 전환하여, {{campaigns_singular_module}} recipeints을 포함하여 서브 패널에있는 다른 기록에 대한 링크를 수정합니다. - 확인 및보기 사용자의 의견과 왼쪽 하단 창에 "작업 스트림"을 전환하여 {{activitystream_singular_module}}의 기록 변화의 역사. - 레코드 이름의 오른쪽에 아이콘을 사용하여이 기록을 따르거나 좋아. - 추가 작업은 편집 버튼의 오른쪽에있는 드롭 다운 동작 메뉴에서 사용할 수 있습니다.',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{}} 모듈 _ 이름은 당신이 대량 마케팅 {{campaigns_singular_module}}에 포함 또는 제외 할 개인이나 조직의 모음으로 구성되어 있습니다. {} {모듈 _}를 만들려면. 1 원하는 필드의 값을 제공합니다. - 필드는 "필수"로 표시하기 전에 저장을 완료해야합니다. - 필요한 경우 추가 필드를 노출 "더보기"를 클릭합니다. 2. 새 레코드를 완료하고 이전 페이지로 돌아갑니다 "저장"을 클릭합니다. - 선택 "저장 및보기"레코드보기에 {} {모듈 _} 새를 엽니 다. - 선택 "저장 및 새로 작성"바로 또 다른 새로운 만들 수 {{모듈 _}}을. 3. 저장 한 후, {{}} campaigns_singular_module받는 사람을 추가하는 대상의 레코드 뷰에서 사용할 수있는 서브 패널을 사용합니다.',
);

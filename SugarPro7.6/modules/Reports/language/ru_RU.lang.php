...
$mod_strings = array (
  ...
  'LBL_REPORT_SHOW_DETAILS' => 'Показать подробности',
...
// report_name
  ...
  'LBL_TOTAL' => 'Итого',
  'LBL_MODULE_NAME_SAVED' => 'Название объекта (модуля)',
  ...
  'LBL_RUN_REPORT_BUTTON_LABEL' => 'Запустить отчет [Alt+R]',
  ...
  'LBL_SHOW_DETAILS' => 'Показать подробности',
  ...
  'LBL_IS_NOT_EMPTY'=>'Не является пустым',
	...
	'LBL_OWNER' => 'За кем ответственный (-ая)',
	'LBL_TEAM' => 'Команды',
  'LBL_TOTAL_IS'=>'Всего',
  ...
  'LBL_GROUP_BY_REQUIRED'=>'По крайней мере один параметр группировки и один столбец итогов требуются для создания диаграммы.',
    ...
    'LBL_FAVORITE_REPORTS_TITLE' => 'Избранное',
    ...
    'DEFAULT_REPORT_TITLE_2' => 'Детальный отчет',
    ...
    'LBL_NO_EXPORT_ACCESS' => 'Запрещенный экспорт',
  	...
  	'LBL_REPORT_DETAILS'=>'Подробности отчета [Alt+D]',

...
// report_name
  ...
  'LBL_TOTAL' => 'סך-הכל',
  'LBL_MODULE_NAME_SAVED' => 'שם מודול',
  ...
  'LBL_RUN_REPORT_BUTTON_LABEL' => 'Run Report [Alt+R]',
  ...
  'LBL_GROUP_BY_REQUIRED'=>'At least one Group By and one Summary column are required to render a chart.<br>',
    ...
    'LBL_LIST_PUBLISHED' => 'בוצע בהצלחה',
    'LBL_THIS_WEEK'=>'השבוע',
    ...
    'DEFAULT_REPORT_TITLE_3' => 'רשימת חשבונות של שותפים',
    'DEFAULT_REPORT_TITLE_4' => 'רשימת חשבונות של לקוחות',
    ...
    'LBL_NO_EXPORT_ACCESS' => 'ייצוא אינו פעיל',
  	...
  	'LBL_REPORT_DETAILS'=>'Report Details [Alt+D]',
  	'LBL_REPORT_GROUP_BY'=>'ממוין על ידי',
  	'LBL_CLEAR'=>'Clear',

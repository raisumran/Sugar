...
$mod_strings = array (
  ...
  'LBL_SELECTED_MODULE' => 'Избрани модули:',
  'LBL_SELECTED_TEMPLATE' => 'Избрани шаблони:',
  'LBL_SELECTED_ITEMS' => 'Избрани записи:',
  'LBL_STEP_5' => 'Сливането на писма е завършено',
  'LBL_MERGED_FILE' => 'Файл за сливане:',
  'LNK_NEW_MAILMERGE' => 'Сливане на писма:  начало',
  'LNK_UPLOAD_TEMPLATE' => 'Зареждане на шаблон',
  ...
  'LBL_CONTAINS_CONTACT_INFO' => 'Избраните шаблони съдържат контактна информация',
  'LBL_ADDIN_NOTICE' => 'Тази функция изисква наличието на инсталирно приложение Sugar Mail Merge на Microsoft Word.',
  'LBL_BROWSER_NOTICE' => 'Необходимо е да работите с версия IE 6.0 или по-нова, за да изпълните текущо сливане.',
  'LBL_REMOVE' => 'Премахни запис(и)' /*for 508 compliance fix*/,
  'LBL_ADD' => 'Добави запис(и)' /*for 508 compliance fix*/,
  'LBL_BROWSER_REQUIREMENT' => 'Изисква се IE версия 6.0 или по-висока за Windows.',
  'LBL_FORM_SELECT_TEMPLATE' => 'Моля изберете шаблон.',
  'LBL_SELECT_ONE' => 'Моля изберете поне един запис.',

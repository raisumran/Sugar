...
$mod_strings = array (
	...
	'ERR_IE_MISSING_REQUIRED'			=> "インバウンドメール設定に必要な情報が不足しています。<br />設定を確認して再実行してください。<br /><br />インバウンドメールを設定していない場合は、このセクションのすべてのフィールドをクリアしてください。",
	...
	'ERR_USER_NAME_EXISTS_2'			=> 'は既に存在します。ユーザ名の重複はできません。ユーザ名を一意に変更してください。',
	...
	'ERR_SERVER_SMTP_EMPTY'				=> 'システムはユーザにメールを送信することができません。<a href="index.php?module=EmailMan&amp;amp;action=config">Eメールの設定</a>で送信用の設定を確認してください。',
	...
	'LBL_NUMBER_GROUPING_SEP_TEXT'		=> '1000位の区切り文字です。',
    ...
    'LBL_GENERATE_PASSWORD_BUTTON_TITLE'   => 'パスワードのリセット',
    ...
    'LBL_MODULE_NAME'					=> 'ユーザ',
    'LBL_MODULE_NAME_SINGULAR'				=> 'アサイン先',
...
// MASS REASSIGNMENT SCRIPT STRINGS
    ...
    'LBL_REASS_CANNOT_PROCESS'		    => '実行されませんでした:',
	'LBL_REASS_NONE'					=> 'なし',
	'LBL_REASS_UPDATE_COMPLETE'			=> '更新完了',
...
// INBOUND EMAIL STRINGS
	...
	'LBL_EMAIL_INBOUND_TITLE'			=> 'インバウンドメール設定',
	...
	'LBL_ONLY_SINCE_NO'					=> 'いいえ　メールサーバのすべてのEメールをチェック',

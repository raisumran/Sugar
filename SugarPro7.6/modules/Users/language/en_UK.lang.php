...
$mod_strings = array (
	...
	'ERR_NO_LOGIN_MOBILE'				=> 'Your first login to this application must be completed with a non-mobile browser or in normal mode. Please return with a full browser or click on the normal link below. We apologise for any inconvenience.',
    ...
    'LBL_CHOOSE_A_KEY'					=> 'Choose a key to prevent unauthorised publishing of your calendar',
...
// MASS REASSIGNMENT SCRIPT STRINGS
	...
	'LBL_REASS_DESC_PART1'				=> 'Select the modules containing the records to reassign from a specific user to another user. <br/><br/><br />                                                            Click Next to view the number of records that will be updated in each selected module.<br />                                                            Click Cancel to exit the page without reassigning any records.',

...
$mod_strings = array (
	...
	'ERR_USER_NAME_EXISTS_2'			=> 'موجود بالفعل.	 لا يُسمح بتكرار أسماء المستخدمين.	 قم بتغيير اسم المستخدم لكي يصبح اسمًا فريدًا.',
    ...
    'LBL_CURRENCY_SHOW_PREFERRED_TEXT'  => 'تحويل العملة الأساسية للعملة المفضلة من قبل المستخدم في القائمة وطرق عرض السجل',
...
// INBOUND EMAIL STRINGS
	...
	'LBL_ONLY'							=> 'فقط',
    'LBL_OWN_OPPS_DESC'                 => 'حدد إذا لم يكن سيتم تعيين فرص للمستخدم. استخدم هذا الإعداد للمستخدمين المديرين غير المتضمنين في أنشطة المبيعات. يستخدم هذا الإعداد لوحدة التنبؤ.',

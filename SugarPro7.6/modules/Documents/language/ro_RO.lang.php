...
$mod_strings = array (
    ...
    'LBL_SELECTED_REVISION_FILENAME' => 'Revizia Numelui fisierului selectat',
    'LBL_FILE_URL' => 'Fisier URL',
    'LBL_REVISIONS_PANEL' => 'Detalii revizie',
    'LBL_REVISIONS_SUBPANEL' => 'Revizii',

    //document search form.
    'LBL_SF_DOCUMENT' => 'Nume Document',
    'LBL_SF_CATEGORY' => 'Categorie',
    'LBL_SF_SUBCATEGORY'=> 'sucategorie',
    ...
    'LBL_THEREVISIONS_SUBPANEL_TITLE' => 'Revizii',
    'LBL_DOCUMENT_INFORMATION' => 'Privire de ansamblu asupra sarcinii',
    'LBL_DOC_ID' => 'Sursa document de identitate',
    'LBL_DOC_TYPE' => 'Sursa:',
    'LBL_LIST_DOC_TYPE' => 'Sursa:',
    'LBL_DOC_TYPE_POPUP' => 'Selectaţi o sursă pentru care acest document va fi încărcat<br />şi de la care va fi disponibil.',
    'LBL_DOC_URL' => 'Document Sursa URL',
    'LBL_SEARCH_EXTERNAL_DOCUMENT' => 'Nume Fisier',
    'LBL_EXTERNAL_DOCUMENT_NOTE' => 'Primele 20  cel mai recent modificate sunt afişate în ordine descrescătoare în lista de mai jos. Utilizaţi Căutare pentru a găsi alte fişiere.',
    'LBL_LIST_EXT_DOCUMENT_NAME' => 'Nume Fisier',
    'ERR_INVALID_EXTERNAL_API_ACCESS' => 'Utilizatorul a încercat să acceseze un API invalid extern ({0})',
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'Logarea a esuat pentru extern API ({0})',

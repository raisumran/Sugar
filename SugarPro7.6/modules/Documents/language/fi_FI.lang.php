...
$mod_strings = array (
    ...
    'LBL_NAME' => 'Nimi',
    'LBL_DOCUMENT_NAME' => 'Dokumentin nimi',
    ...
    'LBL_LATEST_REVISION' => 'Uusin revisio',
    ...
    'LBL_REVISIONS_PANEL' => 'Version tiedot',
    ...
    'LBL_DOCUMENT_INFORMATION' => 'Yleiskatsaus',
    'LBL_DOC_ID' => 'Dokumentin lähteen ID',
    'LBL_DOC_TYPE' => 'Lähde',
    'LBL_LIST_DOC_TYPE' => 'Lähde',
    'LBL_DOC_TYPE_POPUP' => 'Valitse lähde, johon tämä dokumentti ladataan <br> ja josta se on saatavilla.',
    'LBL_DOC_URL' => 'Dokumentin lähteen URL',
    'LBL_SEARCH_EXTERNAL_DOCUMENT' => 'Tiedostonimi',
    'LBL_EXTERNAL_DOCUMENT_NOTE' => 'Ensimmäiset 20 viimeksi muokattua tiedostoa näkyvät laskevassa järjestyksessä alla olevasta luettelosta. Käytä hakua löytääksesi muita tiedostoja.',
    'LBL_LIST_EXT_DOCUMENT_NAME' => 'Tiedostonimi',
    'ERR_INVALID_EXTERNAL_API_ACCESS' => 'Käyttäjä yritti ottaa yhteyttä virheelliseen ulkopuoliseen APIin ({0})',
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'Ulkopuolisen APIN ({0}) kirjautumisen tarkastus epäonnistui',

...
$mod_strings = array (
    ...
    'LBL_REVISIONS_PANEL' => 'تفاصيل المراجعة',
    'LBL_REVISIONS_SUBPANEL' => 'المراجعات',
    ...
    'LBL_THEREVISIONS_SUBPANEL_TITLE' => 'التنقيحات',
    'LBL_DOCUMENT_INFORMATION' => 'نظرة عامة',
    'LBL_DOC_ID' => 'معرّف مصدر المستند',
    'LBL_DOC_TYPE' => 'المصدر',
    'LBL_LIST_DOC_TYPE' => 'المصدر',
    'LBL_DOC_TYPE_POPUP' => 'قم بتحديد مصدر ليتم تحميل المستند إليه <br> ويكون متاحًا من خلاله.',
    'LBL_DOC_URL' => 'عنوان URL لمصدر المستند',
    'LBL_SEARCH_EXTERNAL_DOCUMENT' => 'اسم الملف',
    'LBL_EXTERNAL_DOCUMENT_NOTE' => 'يتم عرض أول 20 ملفًا تم تعديلها حديثًا بترتيب تنازلي في القائمة أدناه. استخدم البحث للعثور على الملفات الأخرى.',
    'LBL_LIST_EXT_DOCUMENT_NAME' => 'اسم الملف',
    'ERR_INVALID_EXTERNAL_API_ACCESS' => 'حاول المستخدم الوصول إلى API خارجي غير صحيح ({0})',
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'فشل فحص تسجيل الدخول لـ API خارجي ({0})',

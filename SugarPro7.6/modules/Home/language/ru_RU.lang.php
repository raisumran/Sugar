...
$mod_strings = array (
  ...
  'LNK_NEW_QUOTE' => 'Создать коммерческое предложение',
    ...
    'LBL_SOURCE_TIMEAGO' => 'jquery timeago - плагин jQuery, который облегчает поддержку автоматически обновляемых нечетких временных меток',
  ...
  'LBL_CREATE_DASHBOARD_MENU' => 'Создать дашборд',
  ...
  'LBL_MY_FAVORITE_REPORT_CHARTS' => 'Избранное',

...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_TIMEPERIODS_BACKWARD' => 'Изберете брой на минали периоди, които да бъдат показвани в плана.<br><i>Този брой се прилага спрямо избрания основен времеви период. Например изборът на 2 минали периода при основен период месец ще покаже 6 минали месеца</i>',
    ...
    'LBL_FORECASTS_CONFIG_GENERAL_FORECAST_BY_PRODUCT_LINE_ITEMS' => 'Приходни позиции',
    ...
    'LBL_FORECASTS_CONFIG_WORKSHEET_SCENARIOS_LIKELY' => 'Вероятен сценарий',
    ...
    'LBL_DASHLET_FORECAST_NOT_SETUP_ADMIN' => 'Прогнозите не са конфигурирани и необходимо да се извърши конфигурация. <a href="#Forecasts/config">Натиснете тук, за да конфигурирате модул Прогнози</a>.',
    ...
    'LBL_FORECAST_DETAILS_NO_DATA' => 'Лиспват данни',

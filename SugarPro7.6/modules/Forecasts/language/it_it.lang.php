...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configura il modo con cui vorresti contrassegnare la {{forecastByModule}} (per esempio quale {{forecastByModule}} dovrebbe essere inclusa o esclusa dai numeri di previsione). Puoi scegliere quante categorie e stabilire l´intervallo di probabilità per le categorie. La {{forecastByModule}} con probabilità certa verrà assegnata alla categoria corrispondente. Dopo l´assegnazione iniziale, l´utente può modificare manualmente il valore. Solo la {{forecastByModule}} nella categoria "Inclusa" sarà segnalata ai managers come confermata.',
    ...
    'LBL_FORECASTS_CONFIG_GENERAL_FORECAST_BY_PRODUCT_LINE_ITEMS' => 'Elemento dell´Opportunità',
    ...
    'LBL_FORECASTS_CONFIG_WORKSHEET_SCENARIOS_LIKELY' => 'Importo',
    ...
    'LBL_PRODUCT_TEMPLATE' => 'Catalogo Prodotti',

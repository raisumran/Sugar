...
$mod_strings = array (
    ...
    'LBL_OW_TYPE'=>'Type e-mailsjabloon',

    //forecast worksheet direct reports forecast
    'LBL_FDR_USER_NAME'=>'Via Rapportering',
    ...
    'LB_FS_LIKELY_CASE'=>'Meest waarschijnlijke scenario',
    'LB_FS_WORST_CASE'=>'Slechtste scenario',
    'LB_FS_BEST_CASE'=>'Beste scenario',
    ...
    'LBL_FDR_C_BEST_CASE'=>'Beste scenario',
    'LBL_FDR_C_WORST_CASE'=>'Slechtste scenario',
    'LBL_FDR_C_LIKELY_CASE'=>'Meest waarschijnlijke scenario',
    ...
    'LBL_CHART_TYPE' => 'Type e-mailsjabloon',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wil categorizeren.<br><br>Let op dat de gekozen instellingen voor het bereik niet meer gewijzigd kunnen worden na de eerste commit. For omgevingen die zijn geupgrade, is het bereik vastgezet in de bestaande forecastgegevens.<br><br>U kunt twee of meer categorieën selecteren gebaseerd op het bereik van waarschijnlijkheid of nieuwe categorieën aanmaken die niet gebaseerd zijn op waarschijnlijkheid.<br><br>Er zijn check-boxes links naar de aangepaste categorieën; gebruik deze om te kiezen welke bereiken meegenomen worden in de forecastbedragen en gerapporteerd aan managers.<br><br>Een gebruiker kan de inclusief/exclusief status en categorie van {{forecastByModule}} handmatig aanpassen in hun werkblad.',
    ...
    'LBL_FORECASTS_CONFIG_TIMEPERIODS_BACKWARD' => 'Kies het aantal afgelopen periodes die zichtbaar zijn voor gebruikers,<br><i>Dit aantal is van toepassing op de gekozen basis periode. Bijvoorbeeld door 2 te kiezen met een maandelijkse periode, zal de afgelopen 6 maanden getoond worden</i>',

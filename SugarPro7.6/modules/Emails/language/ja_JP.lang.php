...
$mod_strings = array (
    ...
    'LBL_ATTACH_SUGAR_DOC'      => 'Sugar Docを添付する',
	...
	'LBL_EMAIL_ARCHIVING'		=> 'アーカイブされたEメール',
    ...
    'LBL_EMAILS_REVENUELINEITEMS_REL' => 'Eメール:高収益商品',
	...
	'LBL_SAVE_AS_DRAFT_BUTTON_LABEL'=> '下書き保存',
	'LBL_SAVE_AS_DRAFT_BUTTON_TITLE'=> '下書き保存',
	...
	'LBL_NO_BODY_SEND_ANYWAYS'	=> 'Eメールの本文がありません。送信/保存しますか?',
	'LBL_NO_SUBJECT_NO_BODY_SEND_ANYWAYS' => 'Eメールの件名と本文がありません。送信/保存しますか?',
	...
	'LBL_BUTTON_REPLY'			=> '返信[Alt+R]',
        'LBL_BUTTON_REPLY_ALL'		=> '全員に返信',
	'LBL_CASES_SUBPANEL_TITLE'	=> 'ケース',
	'LBL_INBOUND_TITLE'			=> 'グループメールアカウント',
	'LBL_INTENT'				=> '目的',
	...
	'LBL_BUTTON_DISTRIBUTE'		=> 'アサイン[Alt+A]',
	'LBL_BUTTON_GRAB_KEY'		=> 't',
	'LBL_BUTTON_GRAB_TITLE'		=> 'グループから取る[Alt+T]',
	'LBL_BUTTON_GRAB'			=> 'グループから取る[Alt+T]',
	...
	'LBL_LIST_TITLE_MY_DRAFTS'	=> '私のドラフト',
    ...
    'LBL_ADD_INBOUND_ACCOUNT' => '追加[Alt+C]',
    'LBL_ADD_OUTBOUND_ACCOUNT' => '追加[Alt+C]',
    ...
    'LBL_ADD_CC_BCC_SEP' => '|',
    'LBL_SEND_EMAIL_FAIL_TITLE' => 'Eメール送信エラー',
    ...
    'LBL_HELP_COMPOSE' => '件名とメール本文を入力し、Eメールを作成してください。Eメールを送信したり、後でEメールモジュール内のフォルダーからドラフトの編集するためには、「アクション」メニューから「下書きとして保存」を選択するか、「送信」をクリックしてください',

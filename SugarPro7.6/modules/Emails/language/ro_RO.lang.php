...
$mod_strings = array (
    ...
    'LBL_ARCHIVED_EMAILS_CREATE'  => 'Creaza',
    'LBL_ATTACH_SUGAR_DOC'      => 'Atasati documente Sugar',
	...
	'LBL_COMPOSE_MODULE_NAME_SINGULAR' => 'Scrie email',
    ...
    'LBL_DRAFT_SAVING'          => 'salvarea proiectului',
    'LBL_DRAFT_SAVED'           => 'Proiect de salvat.',
	...
	'LBL_EMAIL_ARCHIVING'		=> 'Arhivare e-mail',
    ...
    'LBL_EMAIL_SENDING'         => 'trimitere de e-mail',
    'LBL_EMAIL_SENT'            => 'Email trimis',
    ...
    'LBL_EMAILS_PRODUCTS_REL' => 'E-mail-uri: Produse',
    'LBL_EMAILS_REVENUELINEITEMS_REL' => 'E-mail-uri: Elemente venit',
	...
	'LBL_MODULE_NAME_SINGULAR_NEW' => 'Arhiva Email',
	'LBL_MODULE_NAME'			=> 'Email-uri',
	'LBL_MODULE_NAME_SINGULAR'		=> 'Oricare Email:',
	...
	'LBL_SAVE_AS_DRAFT_BUTTON_LABEL'=> 'Salveaza versiune preliminara',
	'LBL_SAVE_AS_DRAFT_BUTTON_TITLE'=> 'Salveaza versiune preliminara',
    ...
    'LBL_SEARCH_IMPORTED_EMAIL' => 'Căutare e-mail importat',
	'LBL_SEND_ANYWAYS'			=> 'Emailul nu are subiect...Salveaza/trimite oricum?',
	'LBL_NO_BODY_SEND_ANYWAYS'	=> 'Acest e-mail nu are corp. Trimite / salvati oricum?',
	'LBL_NO_SUBJECT_NO_BODY_SEND_ANYWAYS' => 'Acest e-mail nu are nici subiect și nici continut. Trimite / salveaza oricum?',
	...
	'LBL_TO_ADDRS'				=> 'Catre',
    'LBL_UPLOAD_ATTACHMENT'     => 'Incarca nou',
	...
	'LBL_LIST_TIME'				=> 'Timpul de start',
	'LBL_LIST_TO_ADDR'			=> 'Catre',
	'LBL_LIST_TYPE'				=> 'Tip',
	...
	'LBL_BUTTON_DISTRIBUTE'		=> 'Atribuie[Alt+A]',
	'LBL_BUTTON_GRAB_KEY'		=> 't',
	'LBL_BUTTON_GRAB_TITLE'		=> 'Ia din grup[Alt+T]',
	'LBL_BUTTON_GRAB'			=> 'Ia din grup[Alt+T]',
	...
	'LBL_QUICK_REPLY'			=> 'Raspunde [Alt+R]',
	'LBL_REPLIED'				=> 'Raspuns',
	...
	'LBL_LIST_TITLE_GROUP_INBOX'=> 'Grupeaza stocare',
	...
	'LNK_QUICK_REPLY'			=> 'Raspunde [Alt+R]',
    ...
    'LBL_ADD_INBOUND_ACCOUNT' => 'Adauga [Alt+C]',
    'LBL_ADD_OUTBOUND_ACCOUNT' => 'Adauga [Alt+C]',
	...
	'LBL_CREATE_CASES' => 'Creaza Cazuri' /*for 508 compliance fix*/,
	'LBL_CREATE_LEADS' => 'Create Leads' /*for 508 compliance fix*/,
	'LBL_CREATE_CONTACTS' => 'Crarea Contacte' /*for 508 compliance fix*/,
	'LBL_CREATE_BUGS' => 'Creare Bugs' /*for 508 compliance fix*/,
	'LBL_CREATE_TASKS' => 'Creare Sarcini' /*for 508 compliance fix*/,
	'LBL_CHECK_INLINE' => 'Corect' /*for 508 compliance fix*/,
	'LBL_CLOSE' => 'inchis' /*for 508 compliance fix*/,
	...
	'LBL_COMPOSEEMAIL' => 'Scrie email' /*for 508 compliance fix*/,
	...
	'LBL_DATE_CREATED' => 'Data intrarii',
	'LBL_DATE_MODIFIED' => 'Data Modificarii',

    // Email Error Messages
    'LBL_INTERNAL_ERROR' => 'S-a produs o eroare internă de server. Vă rugăm încercaţi din nou.',
    'LBL_INVALID_CONFIGURATION' => 'E-mail-ul nu a fost configurat corect. Vă rugăm realizaţi configurarea corectă.',
    'LBL_INVALID_HEADER' => 'Vă rugăm să furnizaţi toate informaţiile solicitate.',
    'LBL_INVALID_EMAIL' => 'Email Invalid:',
    'LBL_FAILED_TO_CONNECT' => 'Nu s-a reuşit conectarea la serverul e-mail-ului. Vă rugăm să vă asiguraţi că e-mail-ul a fost configurat corect.',
    'LBL_INVALID_ATTACHMENT' => 'Nu s-a putut ataşa fişierul dorit. Vă rugăm să încercaţi din nou.',
    'LBL_MISSING_CONFIGURATION' => 'Nu s-a specificat configurarea e-mail-ului. Vă rugăm să furnizaţi o configurare valabilă a e-mail-ului.',
    'LBL_INVALID_MAILAPI_STATUS' => 'S-a transmis o stare nevalabilă pentru e-mail. Vă rugăm să furnizaţi o stare valabilă.',
    'LBL_EXCEPTION' => 'A apărut o excepţie',
    'LBL_ASSIGNMNT_ACT_RESULT' => 'Rezultat acţiune atribuire',
    'LBL_INVALID_OPS' => 'Operaţiune nevalabilă',
    'LBL_INVALID_TYPE' => 'NOOP: tip nevalabil',
    'LBL_SEE_LOG' => 'NOOP: eroare, consultaţi jurnalul',
    'LBL_NO_FOLDER_TYPE' => 'NOOP: nu s-a definit Tipul directorului',
    'LBL_NOT_SUGAR_FOLDER' => 'NOOP - nu este un director Sugar',
    'LBL_ID_MISMATCH' => 'NOOP: Nepotrivire ID',
    'LBL_NO_SEARCH_CRITERIA' => 'NOOP: nu s-a găsit niciun criteriu de căutare',
    'ERR_RCD_NUM_TO_DEL' => 'Trebuie specificat un număr de înregistrare pentru a şterge e-mail-ul.',
    'ERR_MSG_FAILED' => 'Nr. mesaj : {0} eşuat. Motiv: Mesaj deja importat',
    ...
    'LBL_MAILAPI_INVALID_ARGUMENT_VALUE'  => 'argument {0} - nevalabil sau lipsă',
    'LBL_MAILAPI_INVALID_ARGUMENT_FORMAT' => 'argument {0} - format nevalabil',
    'LBL_MAILAPI_INVALID_ARGUMENT_FIELD'  => 'argument {0} - câmp nevalabil sau lipsă: {1}',

    // Help Message
    'LBL_HELP_COMPOSE_TITLE' => 'Compunere e-mail',
    'LBL_HELP_COMPOSE' => 'Compuneţi un e-mail furnizând un subiect şi un conţinut de e-mail. Faceţi clic pe "Trimitere" pentru a trimite e-mail-ul sau alegeţi "Salvare schiţă" din meniul de acţiuni pentru a salva e-mail-ul pentru editare ulterioară în directorul cu schiţe din modulul E-mail-uri. Puteţi aplica un şablon predefinit utilizând butonul Şablom sau puteţi include una dintre semnăturile dvs, utilizând butonul Semnătură. Utilizaţi butonul Încărcare nou pentru a adăuga un ataşament la e-mail.',

    'LBL_EMAIL_INVALID_USER_CONFIGURATION' => 'Setările dvs. de e-mail nu sunt corect configurate pentru a trimite e-mail-ul. Trebuie configurat un server SMTP în <a href="#bwc/index.php?module=Users">Setări e-mail Profil Utilizator</a>.',
    'LBL_EMAIL_INVALID_SYSTEM_CONFIGURATION' => 'Server-ul SMTP implicit al sistemului nu este configurat. Vă rugăm să contactaţi administratorul dvs. de sistem pentru asistenţă suplimentară.',
);

...
$mod_strings = array (
	...
	'LBL_MODULE_NAME_SINGULAR_NEW' => 'Отправить E-mail в архив',
	...
	'LBL_SEND'					=> 'ОТПРАВИТЬ',
	'LBL_SENT_MODULE_NAME'		=> 'Отправленные',
	...
	'LNK_NEW_EMAIL'				=> 'Отослать по электронной почте',
	...
	'LBL_LIST_FORM_SENT_TITLE'	=> 'Отправленные',
	...
	'LBL_BUTTON_REPLY'			=> 'Ответить [Alt+R]',
        'LBL_BUTTON_REPLY_ALL'		=> 'Ответить всем',
	'LBL_CASES_SUBPANEL_TITLE'	=> 'Обращения',
	'LBL_INBOUND_TITLE'			=> 'Групповая учетная запись E-mail',
	'LBL_INTENT'				=> 'Цель',
	...
	'LBL_BUTTON_DISTRIBUTE'		=> 'Назначить [Alt+A]',
	'LBL_BUTTON_GRAB_KEY'		=> 't',
	'LBL_BUTTON_GRAB_TITLE'		=> 'Взять из группы [Alt+T]',
	'LBL_BUTTON_GRAB'			=> 'Взять из группы [Alt+T]',
	...
	'LBL_QUICK_REPLY'			=> 'Ответить [Alt+R]',
	...
	'LNK_QUICK_REPLY'			=> 'Ответить [Alt+R]',
	...
	'LBL_MEMBER_OF'				=> 'Родительский элемент/источник/исходный элемент',
    ...
    'LBL_ADD_INBOUND_ACCOUNT' => 'Добавить [Alt+C]',
    'LBL_ADD_OUTBOUND_ACCOUNT' => 'Добавить [Alt+C]',
    ...
    'LBL_ADD_CC_BCC_SEP' => '|',
    'LBL_SEND_EMAIL_FAIL_TITLE' => 'Ошибка при отправке E-mail',
	...
	'LBL_WAIT' => 'Ожидание' /*for 508 compliance fix*/,

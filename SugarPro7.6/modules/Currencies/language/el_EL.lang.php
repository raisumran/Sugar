...
$mod_strings = array (
  ...
  'LBL_MODULE_NAME_SINGULAR' => 'Νόμισμα',
  'LBL_LIST_FORM_TITLE' => 'Νομίσματα',
  'LBL_CURRENCY' => 'Νόμισμα',
  'LBL_ADD' => 'Προσθήκη',
  'LBL_MERGE' => 'Συγχώνευση',
  'LBL_MERGE_TXT' => 'Παρακαλώ, επιλέξτε τα νομίσματα που θα θέλατε να αντιστοιχίσετε με το επιλεγμένο νόμισμα. Αυτό θα διαγράψει όλα τα επιλεγμένα με νομίσματα και οποιαδήποτε σχετική τιμή.',
  'LBL_US_DOLLAR' => 'Δολάριο Η.Π.Α.',
  'LBL_DELETE' => 'Διαγραφή',
  'LBL_LIST_SYMBOL' => 'Σύμβολο Νομίσματος',
  'LBL_LIST_NAME' => 'Όνομα Νομίσματος',
  ...
  'LNK_NEW_OPPORTUNITY' => 'Nέα Ευκαιρία',

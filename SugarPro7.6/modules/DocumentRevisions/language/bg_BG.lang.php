...
$mod_strings = array (
	//module
	'LBL_MODULE_NAME' => 'Ревизия на документ',
	'LBL_MODULE_NAME_SINGULAR' => 'Ревизия на документ',
	...
	'LBL_DET_CREATED_BY' => 'Създадено от:',
	'LBL_DET_DATE_CREATED' => 'Създадено на:',

	'LBL_DOC_NAME' => 'Име на документа:',
	'LBL_DOC_VERSION' => 'Версия:',

	//document revisions.
	'LBL_REV_LIST_REVISION' => 'Ревизия',
	'LBL_REV_LIST_ENTERED' => 'Въведено на',
	'LBL_REV_LIST_CREATED' => 'Създадено от',
	'LBL_REV_LIST_LOG'=> 'Дневник на промените за записа',
	'LBL_REV_LIST_FILENAME' => 'Файл',

	'LBL_CURRENT_DOC_VERSION'=> 'Последна ревизия:',

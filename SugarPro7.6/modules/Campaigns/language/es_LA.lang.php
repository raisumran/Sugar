...
$mod_strings = array (
  ...
  'LBL_EMAIL_TITLE'=>'Campañas: E-mails',
  ...
  'LBL_CAMPAIGN_COST_PER_CLICK_THROUGH' => 'Costo por clic a través de:',
  ...
  'LBL_EMAIL_CAMPAIGNS_TITLE' =>'Campañas por Correo Electrónico',
  ...
  'LBL_EMAIL_MARKETING_SUBPANEL_TITLE' => 'Mercadotecnia por Correo Electrónico',
  ...
  'LBL_TODETAIL_BUTTON_TITLE'=>'Detalles del Informe [Alt+D]',
  'LBL_TODETAIL_BUTTON_KEY'=>'T',
  'LBL_TODETAIL_BUTTON_LABEL'=>'Detalles del Informe [Alt+D]',
  ...
  'LBL_CAMPAIGN_LEAD_SUBPANEL_TITLE'=>'Prospectos',
  ...
  'LBL_TARGETED' => 'Objetivo',
  'LBL_TOTAL_TARGETED' => 'Objetivo Total',
  ...
  'LBL_EMAIL_SETUP_WIZARD'=>   'Configurar Correo Electrónico',
  ...
  'LBL_TEST_TYPE_NAME'=>'Comprobar [Alt+T]',
  ...
  'LBL_WIZ_SENDMAIL_TITLE' => 'Enviar Correo Electrónico',
  'LBL_WIZ_TEST_EMAIL_TITLE' => 'Probar Correo Electrónico',
  ...
  'LBL_NAVIGATION_MENU_TRACKERS' => 'Rastreos',
  'LBL_NAVIGATION_MENU_MARKETING' => 'Marketing',
  'LBL_NAVIGATION_MENU_SEND_EMAIL' => 'Enviar Correo Electrónico',
  'LBL_NAVIGATION_MENU_SUBSCRIPTIONS' => 'Subscripciones',
  'LBL_SUBSCRIPTION_TARGET_WIZARD_DESC' =>  'Esto definirá la lista de público objetivo de tipo Suscripción para esta campaña.<br>  Esta lista de público objetivo se usará para enviar los correos de esta campaña.  <br>Si no ha preparado previamente una lista, el sistema creará para usted una lista vacía.',
  'LBL_UNSUBSCRIPTION_TARGET_WIZARD_DESC' => 'Esto definirá la lista de público objetivo de tipo No suscripción para esta campaña.  <br>Esta lista de público objetivo contendrá los nombres de las personas que han decidido no participar en su campaña y no deberían ser contactados por Correo Electrónico. <br>Si no ha preparado previamente una lista, el sistema creará para usted una lista vacía.',
  'LBL_TEST_TARGET_WIZARD_DESC' => 'Esto definirá la lista de público objetivo de tipo Pruebas para esta campaña.  <br>Esta lista de público objetivo se usará para enviar correos de pruebas para esta campaña.  <br>Si no ha preparado previamente una lista, el sistema creará para usted una lista vacía.',
  'LBL_TRACKERS' => 'Rastreos',
  'LBL_ADD_TRACKER' => 'Nuevo Seguimiento',
  'LBL_ADD_TARGET' => 'Agregar [Alt+C]',
  ...
  'LBL_NO_SUBS_ENTRIES_WARNING' => 'No puede enviar un correo de marketing hasta que su lista de suscriptores tenga al menos una entrada.  Puede rellenar su lista tras finalizar.',
  'LBL_NO_TARGET_ENTRIES_WARNING' => 'No puede enviar un correo de marketing hasta que su lista de público objetivo tenga al menos una entrada.  Puede rellenar su lista tras finalizar.',
  'LBL_NO_TARGETS_WARNING' => 'No puede enviar un correo de marketing hasta que su campaña tenga al menos una lista de público objetivo.',
  'LBL_NONE' => 'ninguna creada',
  'LBL_CAMPAIGN_WIZARD' => 'Asistente de Campañas',
  'LBL_EMAIL' =>'Correo Electrónico',
  'LBL_OTHER_TYPE_CAMPAIGN' => 'Sin-Correos basados en Campaña',
  ...
  'LBL_EMAILS_SCHEDULED' => 'Correos Electrónicos Planificados',
  'LBL_TEST_EMAILS_SENT' => 'Probar Correos Electrónicos Enviados',
  'LBL_USERS_CANNOT_OPTOUT' => 'Los Usuarios de Sistema no pueden optar por no recibir Correos Electrónicos.',
  'LBL_ELECTED_TO_OPTOUT' => 'Ha elegido optar por no recibir Correos Electrónicos.',
  ...
  'ERR_INT_ONLY_EMAIL_PER_RUN'                => 'Sólo se permiten valores enteros para el Número de Correos Electrónicos enviados por lote',
  ...
  'LBL_EMAIL_SETUP_WIZARD_TITLE'              => 'Configuración de Correo Electrónico para Campañas',
  'TRACKING_ENTRIES_LOCATION_DEFAULT_VALUE'   => 'Valor en Config.php para site_url',
  'LBL_NOTIFY_TITLE'                          => 'Opciones de Notificación por Correo Electrónico',
  ...
  'LBL_NAVIGATION_MENU_SETUP'                 => 'Configuración de Correo Electrónico',
  ...
  'LBL_EMAIL_SETUP_DESC'                      => 'Rellene el siguiente formulario para modificar su configuración del sistema de forma que puedan enviarse los Correos Electrónicos de la campaña.',
  ...
  'LNK_CAMPAIGN_DIGNOSTIC_LINK' => 'La campaña puede no tener el comportamiento deseado y sus correos pueden que no sean enviados por las siguientes razones:',
  ...
  'LBL_MAILBOX_CHECK2_GOOD'   => 'Las opciones de Correo Electrónico han sido configuradas:',
  ...
  'LBL_SCHEDULER_CHECK1_BAD'  => 'No se ha configurado el Planificador para procesar los Correos Rebotados de Campaña.',
  'LBL_SCHEDULER_CHECK2_BAD'  => 'No se ha configurado el Planificador para procesar los Correos de Campaña.',
  'LBL_SCHEDULER_NAME' =>   'Planificador',
  'LBL_SCHEDULER_STATUS' =>   'Estado',
  'LBL_MARKETING_CHECK1_GOOD' => 'Se han detectado los componentes de marketing por Correo Electrónico.',
  'LBL_MARKETING_CHECK1_BAD'  => 'No hay Correos de componentes de mercadotecnia detectados, usted tendrá que crear uno para enviar por correo una campaña.',
  ...
  'LBL_EMAIL_SETUP_WIZ' => 'Lanzar Configuración de Correo Electrónico',
  ...
  'LBL_SEND_EMAIL'  => 'Planificar Correo Electrónico',
  'LBL_USE_EXISTING'  => 'Utilizar Existente',
  'LBL_CREATE_NEW_MARKETING_EMAIL' => 'Crear Nuevo Correo Electrónico de Marketing',
  ...
  'LBL_EMAIL_COMPONENTS' => 'Componentes de Correo Electrónico',
  ...
  //web to lead wizard titles
    ...
    'LBL_PROSPECTLISTS_SUBPANEL_TITLE' => 'Público Objetivo',
    'LBL_EMAILMARKETING_SUBPANEL_TITLE' => 'Mercadotecnia por Correo Electrónico',
    'LBL_TRACK_QUEUE_SUBPANEL_TITLE' => 'Fila de Seguimiento',
    'LBL_TARGETED_SUBPANEL_TITLE' => 'Objetivo',
    ...
    'LBL_INVALID EMAIL_SUBPANEL_TITLE' => 'Correo Electrónico No Válido',

...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_PROXY_USERNAME'=>'Имя пользователя',
	...
	'LBL_WIRELESS_LIST_ENTRIES' => 'Количество отображаемых записей на странице',
    'LBL_WIRELESS_SERVER_URL' => 'Сервер Sugar Mobile Plus',
	'LBL_WIRELESS_SUBPANEL_LIST_ENTRIES' => 'Количество отображаемых субпанелей на странице',
    ...
    'PDF_OWNER_PASSWORD_INFO' => 'Если пароль не настроен, документ откроется, как обычно.<br />Если настроен пароль пользователя, программа просмотра PDF попросит ввести пароль перед отображением документа.<br />Если главный пароль будет отличаться от пользовательского, он будет использован для полного доступа.',
...
"More help : www.tcpdf.org",
    ...
    'LBL_ADD_FONT_BUTTON' => 'Добавить [Alt+C]',
...
// Wizard
	...
	'LBL_YAHOO_MAIL' => 'Почта Yahoo' /*for 508 compliance fix*/,

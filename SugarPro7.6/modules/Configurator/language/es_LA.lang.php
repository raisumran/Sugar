...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MODULE_NAME_SINGULAR' => 'Configuración del Sistema',
	...
	'LBL_PROXY_USERNAME'=>'Identificador',
    ...
    'LBL_TWEETTOCASE_ON_DESC' => 'Permitir usuarios para la creación de casos desde Tweets',
    'LBL_TWEETTOCASE_ON' => 'Inhabilitar Tweet&reg; para integración de casos',
    'LBL_TWEETTOCASE_TITLE' => 'Tweet&reg; a caso',
    ...
    'LBL_LOCK_SUBPANELS_DESC' => 'Este ajuste se aplica a los módulos en el modo tradicional.',
    ...
    'TPL_LIST_ENTRIES_PER_LISTVIEW_HELP'=>'Opciones recomendadas están abajo {{listEntriesNum}} para niveles de desempeño aceptables. Como campos adicionales para la vista de lista, este número debería ser reductor final de las opciones recomendadas.',
	'LIST_ENTRIES_PER_SUBPANEL'=>'Elementos por página para subpaneles',
    'TPL_LIST_ENTRIES_PER_SUBPANEL_HELP'=>'Opciones recomendadas están abajo {{subpanelEntriesNum}} para niveles de desempeño aceptables. Como campos adicionales para la vista de lista, este número debería ser reductor final de las opciones recomendadas.',
	'LBL_WIRELESS_LIST_ENTRIES' => 'Elementos por página para listas',
    'LBL_WIRELESS_SERVER_URL' => 'Servidor Sugar Mobile Plus',
	'LBL_WIRELESS_SUBPANEL_LIST_ENTRIES' => 'Elementos por página para subpaneles',
    ...
    'QUOTES_CURRENT_LOGO'=>'Logo para Cotizaciones',
    ...
    'LBL_ENABLE_HISTORY_CONTACTS_EMAILS' => 'Habilitar/Deshabilitar e-mails de contactos conocidos (o vinculados) para mostrar en el E-mail Subpanel .',
	...
	'LBL_LOGGER_FILENAME'=>'Nombre de Configuración de Registro',
	...
	'LBL_LOGGER_MAX_LOGS'=>'Número máximo de registros (antes de rotación)',
	'LBL_LOGGER_FILENAME_SUFFIX' =>'Agregar tras el nombre de archivo',
	'LBL_VCAL_PERIOD' => 'Período de Tiempo para Actualizaciones vCal:',
    'LBL_NO_PRIVATE_TEAM_UPDATE' => 'Prevenga cambios de nombre por usuarios para actualizar su Nombre de Equipo Privado',
    'LBL_IMPORT_MAX_RECORDS' => 'Importación - Número máximo de filas:',
    ...
    'PDF_HEADER_LOGO_WIDTH' => 'Anchura de Imagen para Cotizaciones',
    'PDF_HEADER_LOGO_WIDTH_INFO' => 'Cambia la escala de la imagen subida que aparece en los Documentos PDF de Cotizaciones. (sólo TCPDF)',
    ...
    'PDF_NEW_SMALL_HEADER_LOGO' => 'Seleccione una Nueva Imagen',
    ...
    'K_SMALL_RATIO_INFO' => 'Factor de reducción para la fuente pequeña .',

    'HEAD_MAGNIFICATION' => 'Aumento de la Cabecera',
    'HEAD_MAGNIFICATION_INFO' => 'Magnificación para los títulos.',

    'PDF_IMAGE_SCALE_RATIO' => 'Relación de escala de la imagen',
    'PDF_IMAGE_SCALE_RATIO_INFO' => 'Relación utilizada para escalar las imágenes',
...
"More help : www.tcpdf.org",
    ...
    'LBL_ADD_FONT_BUTTON' => 'Agregar [Alt+C]',
...
// Password settings
    'ERR_EMPTY_SAML_LOGIN' => 'URL SAML de Ingreso no puede estar vacía',
    'ERR_EMPTY_SAML_CERT' => 'Certificación SAML no puede estar vacía',
    'ERR_SAML_LOGIN_URL' => 'URL SAML de Ingreso no es válida',
    'ERR_SAML_SLO_URL' => 'URL SAML SLO no es válida',
);

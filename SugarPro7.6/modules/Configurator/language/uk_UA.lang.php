...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_WIRELESS_LIST_ENTRIES' => 'Кількість відображуваних записів на сторінці',
    ...
    'PDF_OWNER_PASSWORD_INFO' => 'Якщо пароль не налаштований, документ відкриється, як звичайно. <br/> Якщо налаштований пароль користувача, програма перегляду PDF попросить ввести пароль перед відображенням документа. <br/> Якщо головний пароль буде відрізнятися від користувальницького, він буде використаний для повного доступу.',
...
// Wizard
	...
	'LBL_YAHOO_MAIL' => 'Пошта Yahoo' /*for 508 compliance fix*/,

...
$mod_strings = array (
  ...
  'LBL_LIST_EMAIL_ADDRESS' => 'Muu E-post:',
...
//END DON'T CONVERT
  ...
  'LBL_PROSPECT_INFORMATION' => 'Ülesande ülevaade',
  ...
  'LNK_IMPORT_PROSPECT' => 'Impordi potentsiaalsed kliendid',
  ...
  'LBL_RECORD_SAVED_SUCCESS' => 'You successfully created the {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{full_name}}</a>.',
    ...
    'LBL_DNB_BAL_RSLT_CNT' => 'Eesmärgid',

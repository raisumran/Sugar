...
$mod_strings = array (
    ...
    'LBL_LEAD_SOURCE_BY_OUTCOME_DESC' => 'Εμφανίζει αθροιστικά ποσά ευκαιρία ανά επιλεγμένες πηγές προέλευσης ανά αποτέλεσμα για επιλεγμένους χρήστες. Το Αποτέλεσμα βασίζεται είτε εάν το στάδιο πωλήσεων  Έκλεισε Κερδισμένο, Έκλεισε Χαμένο, ή οποιαδήποτε άλλη αξία.',
    'LBL_LEAD_SOURCE_BY_OUTCOME' => 'Όλες οι ευκαιρίες Ανά Πηγή Προέλευσης Ανά Αποτέλεσμα',
    'LBL_LEAD_SOURCE_FORM_DESC' => 'Εμφανίζει αθροιστικά ποσά ευκαιρίας από επιλεγμένη πηγή προέλευσης για επιλεγμένους χρήστες.',
    ...
    'LBL_MODULE_NAME' => 'Πίνακας Εργαλείων',
    ...
    'LBL_NUMBER_OF_OPPS' => 'Αριθμός Ευκαιριών',
    ...
    'LBL_CAMPAIGN_ROI_TITLE_DESC' => 'Εμφανίζει εκστρατεία απόκρισης από την απόδοση των επενδύσεων.',
    ...
    'LBL_SALES_STAGE_FORM_DESC' => 'Εμφανίζει αθροιστικά ποσά ευκαιρίας από επιλεγμέα στάδια πωλήσεων για επιλεγμένους χρήστες, όπου η αναμενόμενη ημερομηνία κλεισίματος είναι εντός του καθορισμένου εύρους ημερομηνίας.',
    'LBL_SALES_STAGE_FORM_TITLE' => 'Διαδρομή Ανά Στάδιο Πώλησης',
    ...
    'LBL_CHART_ACTION' => 'Ενέργεια',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE' => 'Αγωγός ανά Στάδιο Πωλήσεων',
    'LBL_CHART_LEAD_SOURCE_BY_OUTCOME' => 'Πηγή Προέλευσης Ανά Αποτέλεσμα',
    'LBL_CHART_OUTCOME_BY_MONTH' => 'Αποτελέσματα ανά Μήνα',
    'LBL_CHART_PIPELINE_BY_LEAD_SOURCE' => 'Αγωγός Ανά Πηγή Προέλευσης',
    'LBL_CHART_MY_PIPELINE_BY_SALES_STAGE' => 'Ο Αγωγός Μου ανά Στάδιο Πωλήσεων',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE_FUNNEL' => 'Αγωγός ανά Στάδιο Πωλήσεων, Χωνί',
    'LBL_CHART_OPPORTUNITIES_THIS_QUARTER' => 'Ευκαιρίες αυτού του Τριμήνου',
    'LBL_CHART_MY_MODULES_USED_30_DAYS' => 'Ενότητες Χρήσης Μου (Τελευταίες 30 Ημέρες)',
    'LBL_CHART_MODULES_USED_DIRECT_REPORTS_30_DAYS' => 'Ενότητες που Χρησιμοποιούνται Από τις Άμεσες Αναφορές Μου (Τελευταίες 30 Ημέρες)',
    'LBL_CHART_DCE_ACTIONS_MONTH' => 'DCE Ενέργειες ανά Τύπο (Τρέχων Μήνας)',
);

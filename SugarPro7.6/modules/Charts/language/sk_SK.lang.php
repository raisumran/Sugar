...
$mod_strings = array (
    'ERR_NO_OPPS' => 'Prosím, vytvorte nejaké obchody, k zobrazeniu grafov obchodov',
    ...
    'LBL_LEAD_SOURCE_BY_OUTCOME' => 'Všetky obchody podľa Zdroja príležitosti a Výsledkov',
    ...
    'LBL_LEAD_SOURCE_OTHER' => 'Iné',
    'LBL_LEAD_SOURCES' => 'Zdroje príležitostí:',
    'LBL_MODULE_NAME' => 'Prístrojovka',
    'LBL_MODULE_NAME_SINGULAR'	=> 'Prístrojovka',
    ...
    'LBL_NUMBER_OF_OPPS' => 'Počet obchodov',
    'LBL_OPP_SIZE' => 'Veľkosť obchodu v',
    'LBL_OPP_THOUSANDS'=> 'K',
    ...
    'LBL_CAMPAIGN_ROI_TITLE_DESC' => 'Zobrazuje kampane zodpovedajúce návratnosti investícií.',
    'LBL_REFRESH' => 'Obnoviť',
    'LBL_ROLLOVER_DETAILS' => 'Rolovacia lišta pre detaily',
    ...
    'LNK_NEW_ISSUE' => 'Hlásenie o poruche',
    ...
    'LBL_CHART_ACTION' => 'Akcia',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE' => 'Pipeline podľa fázy predaja',
    'LBL_CHART_LEAD_SOURCE_BY_OUTCOME' => 'Hlavný zdroj podľa výsledku',
    'LBL_CHART_OUTCOME_BY_MONTH' => 'Mesačné výsledky',
    'LBL_CHART_PIPELINE_BY_LEAD_SOURCE' => 'Pipeline podľa hlavného zdroja',
    'LBL_CHART_MY_PIPELINE_BY_SALES_STAGE' => 'Moja Pipeline podľa fázy predaja',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE_FUNNEL' => 'Pipeline podľa lievika fázy predaja',
    'LBL_CHART_OPPORTUNITIES_THIS_QUARTER' => 'Príležitosti tento štvrťrok',
    'LBL_CHART_MY_MODULES_USED_30_DAYS' => 'Moje použité moduly (Posledných 30 dní)',
    'LBL_CHART_MODULES_USED_DIRECT_REPORTS_30_DAYS' => 'Moduly využívané mojimi podriadenými  (Posledných 30 dní)',
    'LBL_CHART_DCE_ACTIONS_MONTH' => 'DCE Akcie podľa typu (Aktuálny mesiac)',
);

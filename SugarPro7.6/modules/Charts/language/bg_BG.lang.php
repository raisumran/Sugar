...
$mod_strings = array (
    ...
    'LBL_MODULE_NAME_SINGULAR'	=> 'Електронно табло',
    ...
    'LBL_NUMBER_OF_OPPS' => 'Брой на възможностите',
    ...
    'LBL_CAMPAIGN_ROI_TITLE_DESC' => 'Показва отговор според възвръщаемост на кампанията.',
    'LBL_REFRESH' => 'Обнови',
    ...
    'LNK_NEW_ISSUE' => 'Докладване за проблем',
    ...
    'NTC_NO_LEGENDS' => 'Никой',
    
    'LBL_TITLE' => 'Заглавие:',
    'LBL_MY_MODULES_USED_SIZE' => 'Достъпен',

    'LBL_CHART_ACTION' => 'Действие',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE' => 'Текущи възможности споре етапа на търговски преговори',
    'LBL_CHART_LEAD_SOURCE_BY_OUTCOME' => 'Източници на потенциални клиенти според резултата',
    'LBL_CHART_OUTCOME_BY_MONTH' => 'Резултати по месеци',
    'LBL_CHART_PIPELINE_BY_LEAD_SOURCE' => 'Текущи възможности според източника',
    'LBL_CHART_MY_PIPELINE_BY_SALES_STAGE' => 'Моите текущи възможности според етапа на търговски преговори',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE_FUNNEL' => 'Текущи възможности според етапа на търговски преговори представени като фуния',
    'LBL_CHART_OPPORTUNITIES_THIS_QUARTER' => 'Възможности в текущото тримесечие',
    'LBL_CHART_MY_MODULES_USED_30_DAYS' => 'Моите основни модули за работа (Последните 30 дни)',
    'LBL_CHART_MODULES_USED_DIRECT_REPORTS_30_DAYS' => 'Основни модули за работа на потребители, които се отчитат на мен (Последните 30 дни)',
    'LBL_CHART_DCE_ACTIONS_MONTH' => 'DCE действия според типа (Текущ месец)',
);

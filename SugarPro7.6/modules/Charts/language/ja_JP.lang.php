...
$mod_strings = array (
    ...
    'LBL_SALES_STAGE_FORM_TITLE' => 'セールスステージ別パイプライン',
    ...
    'LBL_CHART_PIPELINE_BY_SALES_STAGE' => 'セールスステージ別のパイプライン',
    'LBL_CHART_LEAD_SOURCE_BY_OUTCOME' => '結果別のリードソース',
    'LBL_CHART_OUTCOME_BY_MONTH' => '月別の結果',
    'LBL_CHART_PIPELINE_BY_LEAD_SOURCE' => 'リードソース別のパイプライン',
    'LBL_CHART_MY_PIPELINE_BY_SALES_STAGE' => 'セールスステージ別の私のパイプライン',
    'LBL_CHART_PIPELINE_BY_SALES_STAGE_FUNNEL' => 'セールスステージフィルタ別のパイプライン',
    ...
    'LBL_CHART_DCE_ACTIONS_MONTH' => 'タイプ別のDCEアクション（今月）',
);

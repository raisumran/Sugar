...
$mod_strings = array (
  ...
  'LBL_ACTION_UPDATE_TITLE' => 'Mise à jour du(des) champ(s) suivant(s) dans le module cible',
  'LBL_ACTION_UPDATE_REL_TITLE' => 'Mise à jour du(des) champ(s) suivant(s) dans un module associé',
  ...
  'LBL_ACTION_UPDATE' => 'Mise à jour du(des) champ(s) dans la cible',
  'LBL_ACTION_UPDATE_REL' => 'Mise à jour du(des) champ(s) dans un module associé',
  ...
  'LBL_PREVIOUS_BUTTON' => 'Précédent',
    ...
    'LBL_ACTION_ERROR'=>'Cette action contient des erreurs et ne peut pas être exécutée. Veuillez éditer cette action afin que chacun des champs et des valeurs de champ soient valides.',
);

...
$mod_strings = array (
    ...
    //module strings.
    'LBL_MODULE_NAME' => '予算マネージャワークシート',
    'LBL_MODULE_NAME_SINGULAR' => '予算マネージャワークシート',
    'LNK_NEW_OPPORTUNITY' => '商談作成',
    'LBL_MODULE_TITLE' => '予算マネージャワークシート',
    'LBL_LIST_FORM_TITLE' => '確定予算',
    'LNK_UPD_FORECAST' => '予算マネージャワークシート',
    'LNK_QUOTA' => 'ノルマ表示',

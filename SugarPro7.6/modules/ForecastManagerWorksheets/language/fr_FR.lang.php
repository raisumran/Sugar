...
$mod_strings = array (
    ...
    //module strings.
    'LBL_MODULE_NAME' => 'Tableaux de gestion des prévisions',
    'LBL_MODULE_NAME_SINGULAR' => 'Tableau de gestion des prévisions',
    'LNK_NEW_OPPORTUNITY' => 'Créer une Affaire',
    'LBL_MODULE_TITLE' => 'Tableaux de gestion des prévisions',
    'LBL_LIST_FORM_TITLE' => 'Prévisions soumises',
    'LNK_UPD_FORECAST' => 'Tableau de gestion des prévisions',
    ...
    'LBL_MY_MANAGER_LINE' => '{{full_name}} (moi)',

    'LBL_EDITABLE_INVALID' => 'Valeur invalide pour {{field_name}}',
    'LBL_EDITABLE_INVALID_RANGE' => 'La valeur doit être entre {{min}} et {{max}}',
    'LBL_HISTORY_LOG' => 'Dernière soumission',
    'LBL_NO_COMMIT' => 'Aucune soumission',

    'LBL_MANGER_SAVED' => 'Tableau sauvegardé'

...
$mod_strings = array (
	...
	'LBL_SELECT_TAG_BUTTON_TITLE' => 'selecionar',
	'LBL_EMBEDED_IMAGES' => 'Imagens Embutidas:',
	'LBL_SHOW_MORE' => 'Exibir mais artigos',
	...
	'LBL_CHANGE_LOG'=> 'Modificar Registro',
    ...
    'LBL_ARTICLE_PREVEW_UNAVAILABLE_NO_DOCUMENT' => 'Previsão não está disponível, Registro do Documento não foi encontrado.',
   ...
   //Admin screen messages
    'LBL_DEFAULT_ADMIN_MESSAGE' =>'Selecione uma ação da lista dropdown',
    'LBL_SELECT_PARENT_TAG_MESSAGE' =>'Selecione a etiqueta de origem da árvore',
    'LBL_SELECT_TAG_TO_BE_DELETED_FROM_TREE' => 'Selecione etiquetas(s) a eliminar da árvore',
    'LBL_SELECT_TAG_TO_BE_RENAMED_FROM_TREE' =>'Selecione a etiqueta a renomear da árvore',
    ...
    'LBL_SELECT_TAGS_FROM_TREE'  => 'Selecione Etiquetas da Árvore',
    'LBL_MOVING_ARTICLES_TO_TAG' =>'A mover artigos para etiqueta...',
    'LBL_APPLYING_TAGS_TO_ARTICLES' =>'A aplicar etiquetas em artigos ...',
    'LBL_ROOT_TAG_MESSAGE' => 'Etiqueta raiz não pode ser Selecionada/ligada ao artigo',
    ...
    'LBL_ERROR_NOT_A_FILE_INPUT_ELEMENT' =>'Erro: Não é um elemento de entrada de arquivo',
    'LBL_CREATE_NEW_TAG'  => 'Nova Etiqueta',
    'LBL_SEARCH_TAG'  => 'Pesquisar',
    'LBL_TAG_NAME'  =>'Nome da Etiqueta:',
    
    'LBL_SELECT_TAGS_TO_DELETE' => 'Selecione Etiquetas a eliminar',
    ...
    'LBL_KB_STATUS_BACK_TO_DRAFT' => 'Status do Documento foi alterado novamente para rascunho',  
    ...
    'LBL_ARTICLE_EXISTS' => 'Artigo existente',

...
$mod_strings = array (
    ...
    'LBL_BILLING_ADDRESS_CITY' => '[账单]城市',
    'LBL_BILLING_ADDRESS_COUNTRY' => '[账单]国家',
    'LBL_BILLING_ADDRESS_POSTAL_CODE' => '[账单]邮编',
    'LBL_BILLING_ADDRESS_STATE' => '[账单]省份',
    'LBL_BILLING_ADDRESS_STREET' => '付款地址',
    'LBL_BILLING_ADDRESS' => '地址:',
    'LBL_BILLING_CONTACT_ID' => '[账单]联系人编号:',
    'LBL_BILLING_CONTACT_NAME' => '[账单]联系人姓名:',
    'LBL_BILLING_CONTACT' => '联系人:',
    'LBL_BUNDLE_NAME' => '组名:',
    'LBL_BUNDLE_STAGE' => '分组阶段:',
    'LBL_BUNDLE_DISCOUNT'=> '折扣：',
    'LBL_CALC_GRAND' => '显示总计',
    'LBL_CHECK_DATA'=>"无效的数据输入: 请检查您的数据并确认您有有效的数字 (0-9 或 $#39;.$#39;)",
    'LBL_CITY' => '城市:',
	...
	'LBL_QUOTE_INFORMATION' => '任务查看',
	'LBL_LIST_MY_QUOTES' => '我的报价',
    'LBL_ATTACHMENT' => '附件' /*for 508 compliance fix*/,
    'NTC_OVERWRITE_ADDRESS_PHONE_CONFIRM' => '该记录目前在地址栏中包含价格.按照您所选的账户地址覆盖这些价格，点击"完成"。',

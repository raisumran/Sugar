...
$mod_strings = array (
    ...
    'LBL_LIST_MANUFACTURER_PART_NUM' => 'Αριθμός Παραγωγής Κατασκευαστή',
    ...
    'LBL_SALES_STAGE'=>'Στάδιο Προσφοράς:',
    ...
    'LBL_SHIPPING_PROVIDER' => 'Πάροχος Αποστολής:',
    'LBL_SHIPPING_USDOLLAR'=>'Παράδοση (US Δολλάριο)',
    'LBL_DEAL_TOT'=>'Σύνολο Έκπτωσης',

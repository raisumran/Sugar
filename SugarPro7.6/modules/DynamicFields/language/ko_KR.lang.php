...
$mod_strings = array (
	...
	'LBL_MODULE' => '모듈',
	'COLUMN_TITLE_MASS_UPDATE'=>'대용량 업데이트',
	...
	'LBL_DEPENDENT_TRIGGER'=>'기회유발',
    'LBL_CALCULATED'=>'가치 계산',
    'LBL_FORMULA'=>'공식',
    'LBL_DYNAMIC_VALUES_CHECKBOX' => '의존',
    'LBL_BTN_EDIT_VISIBILITY'=>'시야 편집하기',
    ...
    'LBL_EDIT_VIS' => '시야 편집하기',
    'LBL_SIMULATION_MODE' => '시뮬레이션 모드 - 캐시 정리외 다른 변경사항은 없습니다.',
    'LBL_SCAN_MODULE' => '스캔중입니다.',
    'LBL_DROPPING_COLUMN' => '모듈을 위해 {0}에서 {1}로 칼럼을 적하합니다.',
    'LBL_FIX_COLUMN_TYPE' => '칼럼형식을 고치기 위해 {0}에서 {1}로 변경합니다.',
    'LBL_FIELD_MISSING' => '에 필드가 없습니다.',

...
$mod_strings = array (
    ...
    'LBL_LIST_EMAIL_ADDRESS' => 'Οποιοδήποτε Email',
    ...
    'LBL_REVENUELINEITEMS_TITLE'=>'Γραμμή Εσόδων',
    ...
    //Dashlet
    'LBL_LINKEDIN' => 'Λογαριασμός Μέλους LinkedIn',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η {{plural_module_name}} ενότητα αποτελείται από μεμονωμένα άτομα, με τους οποίους η εταιρεία σας έχει μια σχέση

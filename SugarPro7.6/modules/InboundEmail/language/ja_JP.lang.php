...
$mod_strings = array(
    ...
    'LBL_FROM_ADDR_DESC'    => "メールサービスプロバイダの制約により、ここで指定されたEメールアドレスが送信済みメールのFromに表示されない場合があります。このような場合は、送信サーバ用のアカウントが用いられます。",
	...
	'LBL_CREATE_CASE_REPLY_TEMPLATE_HELP' => '自動返信オプションを選択することによって、メールの送信者に対し、ケースが作成されたことを通知することができます。Eメールの件名欄には、ケースマクロに応じて生成されたケース番号が付加されます。この返信は、メールが最初に送信されたときにのみ送付されます。',
	'LBL_MAILBOX'			=> '監視フォルダ',
	...
	'LBL_MODULE_NAME_SINGULAR' => 'グループメールアカウント',
	'LBL_BOUNCE_MODULE_NAME' => 'バウンス処理用受信箱',
	'LBL_MODULE_TITLE'		=> 'グループメールアカウント',
	'LBL_NAME'				=> '名前',
    'LBL_NONE'              => 'なし',

 ...
 */
SUGAR.FunctionMap = {
	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'and'	:	SUGAR.expressions.AndExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'now'	:	SUGAR.expressions.NowExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'log'	:	SUGAR.expressions.LogExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */

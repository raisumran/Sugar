<?php /* Smarty version 2.6.11, created on 2016-03-07 04:20:47
         compiled from modules/PdfManager/tpls/templateQuote.tpl */ ?>
<table border="0" cellspacing="2">
<tbody>
<tr>
<td rowspan="4" width="180%"><img src="<?php echo $this->_tpl_vars['logoUrl']; ?>
" alt="" /></td>
<td width="60%"><strong><?php echo $this->_tpl_vars['MOD']['LBL_TPL_QUOTE']; ?>
</strong></td>
<td width="60%">&nbsp;</td>
</tr>
<tr>
<td bgcolor="#DCDCDC" width="75%"><?php echo $this->_tpl_vars['MOD']['LBL_TPL_QUOTE_NUMBER']; ?>
</td>

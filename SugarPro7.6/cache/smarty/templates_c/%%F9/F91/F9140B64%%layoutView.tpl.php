<?php /* Smarty version 2.6.11, created on 2016-11-16 04:55:51
         compiled from modules/ModuleBuilder/tpls/layoutView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/layoutView.tpl', 17, false),array('function', 'sugar_help', 'modules/ModuleBuilder/tpls/layoutView.tpl', 25, false),array('function', 'sugar_image', 'modules/ModuleBuilder/tpls/layoutView.tpl', 38, false),array('function', 'counter', 'modules/ModuleBuilder/tpls/layoutView.tpl', 48, false),array('function', 'sugar_getimage', 'modules/ModuleBuilder/tpls/layoutView.tpl', 54, false),array('function', 'eval', 'modules/ModuleBuilder/tpls/layoutView.tpl', 72, false),array('function', 'sugar_csrf_form_token', 'modules/ModuleBuilder/tpls/layoutView.tpl', 241, false),array('modifier', 'upper', 'modules/ModuleBuilder/tpls/layoutView.tpl', 127, false),array('modifier', 'escape', 'modules/ModuleBuilder/tpls/layoutView.tpl', 316, false),)), $this); ?>
...
?>
        ...
        <div class='le_field' data-name="<?php echo $this->_tpl_vars['field']; ?>
" id='<?php echo $this->_tpl_vars['idCount']; ?>
'>
...
'>
            <?php if (! empty ( $this->_tpl_vars['translate'] ) && ! empty ( $this->_tpl_vars['col']['label'] )): ?>
                ...
                <?php if ($this->_tpl_vars['from_mb']): ?>
                    <?php if (! empty ( $this->_tpl_vars['current_mod_strings'][$this->_tpl_vars['newLabel']] )): ?>
 			...
 			<?php else: ?>
                ...
                <?php endif; ?>
            <?php endif;  if (! empty ( $this->_tpl_vars['col']['fieldset'] )): ?> **<?php endif; ?></span>
            <span class='field_name'><?php echo $this->_tpl_vars['col']['name']; ?>
</span>
            <span class='field_label'><?php echo $this->_tpl_vars['col']['label']; ?>
</span>
            <?php if (! empty ( $this->_tpl_vars['col']['fieldset_fields'] )): ?>
            <span class='field_fieldset_fields' id='fieldset_<?php echo $this->_tpl_vars['idCount']; ?>
'>
                <?php $_from = $this->_tpl_vars['col']['fieldset_fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['fsfield']):
?>
                    <?php echo smarty_function_eval(array('var' => $this->_tpl_vars['fsfield']['label'],'assign' => 'fslabel'), $this);?>

                    <?php if (! empty ( $this->_tpl_vars['translate'] ) && ! empty ( $this->_tpl_vars['fsfield']['label'] )): ?>
                        <?php echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['fslabel'],'module' => $this->_tpl_vars['language']), $this);?>

                    <?php else: ?>
                        <?php if (! empty ( $this->_tpl_vars['current_mod_strings'][$this->_tpl_vars['fslabel']] )): ?>
                            <?php echo $this->_tpl_vars['current_mod_strings'][$this->_tpl_vars['fslabel']]; ?>

                        <?php elseif (! empty ( $this->_tpl_vars['mod'][$this->_tpl_vars['fslabel']] )): ?>
                            <?php echo $this->_tpl_vars['mod'][$this->_tpl_vars['fslabel']]; ?>

                        <?php else: ?>
                            <?php echo $this->_tpl_vars['fslabel']; ?>
...
<div id='panels' style='float:left; overflow-y:auto; overflow-x:hidden' class="max-columns-<?php echo $this->_tpl_vars['maxColumns']; ?>
">
...
" style="float:right;<?php if (isset ( $this->_tpl_vars['tabDefs'][$this->_tpl_vars['panel_upper']]['newTab'] ) && $this->_tpl_vars['tabDefs'][$this->_tpl_vars['panel_upper']]['newTab'] == true): ?>display:none;<?php endif; ?>">
        &nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TABDEF_COLLAPSE','module' => 'ModuleBuilder'), $this); echo smarty_function_sugar_translate(array('label' => 'LBL_QUESTION_MARK'), $this);?>
...
?>
                <?php $this->assign('field', $this->_tpl_vars['col']['name']); ?>
                <div class='le_field' data-name="<?php echo $this->_tpl_vars['col']['name']; ?>
" id='<?php echo $this->_tpl_vars['idCount']; ?>
'>
                    <?php if (! $this->_tpl_vars['fromModuleBuilder'] && ( $this->_tpl_vars['col']['name'] != '(filler)' )): ?>
                        <?php ob_start(); ?>class="le_edit" style="float:right; cursor:pointer;" onclick="editFieldProperties('<?php echo $this->_tpl_vars['idCount']; ?>
...
Studio2.calcFieldList = ';  echo $this->_tpl_vars['calc_field_list'];  echo ';

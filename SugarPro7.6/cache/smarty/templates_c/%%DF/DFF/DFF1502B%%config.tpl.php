<?php /* Smarty version 2.6.11, created on 2016-11-16 04:18:22
         compiled from modules/EmailMan/tpls/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/EmailMan/tpls/config.tpl', 15, false),array('function', 'sugar_csrf_form_token', 'modules/EmailMan/tpls/config.tpl', 35, false),array('modifier', 'escape', 'modules/EmailMan/tpls/config.tpl', 155, false),)), $this); ?>
...
&nbsp;
                                    <img border="0" class="inlineHelpTip" onclick="return SUGAR.util.showHelpTips(this,'<?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_ALLOW_DEFAULT_SELECTION_HELP'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
:&nbsp;
            <img border="0" class="inlineHelpTip" onclick="return SUGAR.util.showHelpTips(this,'<?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_NOTIFICATION_ON_DESC'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
    	</td>
...
:
           <img border="0" class="inlineHelpTip" onclick="return SUGAR.util.showHelpTips(this,'<?php echo ((is_array($_tmp=$this->_tpl_vars['MOD']['LBL_FROM_ADDRESS_HELP'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
    	</td>

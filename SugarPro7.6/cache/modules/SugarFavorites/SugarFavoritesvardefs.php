 ...
 $GLOBALS["dictionary"]["SugarFavorites"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'sugarfavorites_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'sugarfavorites_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'sugarfavorites_activities',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_sugarfavorites_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_sugarfavorites_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_sugarfavorites_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',

<?php 
 $GLOBALS["dictionary"]["PdfManager"]=array (
  'table' => 'pdfmanager',
  'favorites' => false,
  'audited' => false,
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pdfmanager_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pdfmanager_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pdfmanager_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pdfmanager_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pdfmanager_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pdfmanager_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pdfmanager_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pdfmanager_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pdfmanager_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    1 => 
    array (
      'name' => 'idx_pdfmanager_base_module',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'base_module',

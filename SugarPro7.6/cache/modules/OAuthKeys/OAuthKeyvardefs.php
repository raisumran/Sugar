 ...
 $GLOBALS["dictionary"]["OAuthKey"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'oauthkeys_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'oauthkeys_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'oauthkey_activities',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_oauth_consumer_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_oauth_consumer_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_oauth_consumer_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',

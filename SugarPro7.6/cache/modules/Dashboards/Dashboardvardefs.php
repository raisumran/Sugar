 ...
 $GLOBALS["dictionary"]["Dashboard"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'dashboards_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'dashboards_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'dashboard_activities',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_dashboards_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_dashboards_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',

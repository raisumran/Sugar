 ...
 $GLOBALS["dictionary"]["WebLogicHook"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'weblogichooks_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'weblogichooks_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_weblogichooks_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_weblogichooks_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',

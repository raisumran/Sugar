...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'データベースのサポートレイヤが見つかりません。MySQL、MS SQL Server、Oracle、DB2などのデータベースのドライバが適切にインストールされていることを確認してください。お使いのPHPのバージョンによっては、php.iniファイルの当該エクステンションの行のコメントをはずすか、PHPをコンパイルし直す必要があります。データベースをサポートする詳しい方法についてはPHPのマニュアルを参照ください。',
	...
	'LBL_DBCONF_CREATE_USER'			=> 'ユーザ作成 [Alt+N]',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_MINIMUM_PHP_VERSION' => 'PHPのバージョンは5.1.0以上である必要があります。推奨するバージョンは5.2.x以上です。',
	'LBL_YOUR_PHP_VERSION' => '（現在のPHPバージョンは',
	'LBL_RECOMMENDED_PHP_VERSION' =>'です。推奨するバージョンは5.2.x以上です。)',

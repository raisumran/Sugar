...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '데이타베이스 지원이 발견되지 않았습니다. 다음의 지원되는 데이타베이스 형식에 필요한 드라이버를 확인해주십시요-MySQL, MS SQLServer, Oracle, or DB2. php.ini 파일의 확장평가 해지나 알맞은 binary 파일축적 해지는 PHP버전에 따라 달라집니다. 데이타베이스 지원을 위한 보다 더 많은 정보는 PHP 안내책자를 참조하십시요.',
    ...
    'ERR_DB_OCI8_DB_NAME_INVALID'       => "데이타베이스명은 글자와 #&#39;, &#39;_&#39;  &#39;$ 기호만을 포함할수 있습니다.",
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_OOTB_CLEANUP_QUEUE' => '대기중 작업 정리',
	...
	'LBL_MINIMUM_PHP_VERSION' => '최소 필요한 PHP버전은 5.1.0이며 권장 Php 버전은 5.2.x입니다.',

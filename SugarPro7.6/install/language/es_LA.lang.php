...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE'  => 'El fichero config override existe pero no editable. Por favor, realice los pasos necesarios para hacer al fichero editable. Dependiendo de su Sistema Operativo, puede ser necesario cambiar los permisos ejecutando chmod 766 o editar las propiedades del fichero haciendo click con el botón derecho sobre él y desmarcando la casilla de sólo lectura.',
    ...
    'ERR_CHECKSYS_BCMATH'				=> 'BCMATH soporte no encontrado: SugarCRM necesita soporte BCMATH de precisión arbitraria matemática',
    'ERR_CHECKSYS_HTACCESS'             => 'Prueba de reescrituras. Htaccess falló. Esto por lo general significa que usted no tiene Permiso de configuración para configurar el directorio de Sugar.',
	...
	'ERR_DB_LOGIN_FAILURE_MYSQL'		=> 'Los datos de la base de datos proporcionados, nombre de usuario y / o contraseña no son válidos, y la conexión a la base de datos no pudo ser establecida. Por favor, introduzca un servidor válido con nombre de usuario y contraseña',
	'ERR_DB_LOGIN_FAILURE_MSSQL'		=> 'Los datos de la base de datos proporcionados, nombre de usuario y / o contraseña no son válidos, y la conexión a la base de datos no pudo ser establecida. Por favor, introduzca un servidor válido con nombre de usuario y contraseña',
    ...
    'LBL_CHECKSYS_BCMATH'				=> 'Precisión Arbitraria de Módulo Matemático',
    'LBL_CHECKSYS_HTACCESS'				=> 'Permitir la configuración Invalidar. Htaccess',
	...
	'LBL_DBCONF_CREATE_USER'			=> 'Crear Usuario [Alt+N]',
	...
	'LBL_DBCONF_HOST_INSTANCE'			=> 'Anfitrión de iInstancia',
	...
	'LBL_LICENSE_OC_NUM'				=> 'Número de Licencias de Cliente sin conexión',
    ...
    'LBL_SITECFG_COLLATION_MSG'         => 'Seleccione colación (clasificación) para su sistema. Esta configuración crea las tablas con el lenguaje específico que utilice. En caso de que su lenguaje no requiere configuración especial, por favor use el valor por defecto.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'REQUIRED_SYS_COMP_MSG' =>
                    'Antes de empezar, por favor asegúrese de que tiene las versiones soportadas de los siguientes componentes<br />                      del sistema:<br><br />                      <ul><br />                      <li> Base de Datos/Sistema de Gestión de Base de Datos (Ejemplos: MySQL, SQL Server, Oracle)</li><br />                      <li> Servidor Web (Apache, IIS)</li><br />                      </ul><br />                      Consulte la Matriz de Compatibilidad en las Notas de Lanzamiento para <br />                      los componentes del sistema compatibles para la versión de Sugar que está instalando.<br>',
    ...
    'LBL_OOTB_SEND_EMAIL_REMINDERS'	=> 'Ejecutar Envío de Correos de Recordatorios',
    'LBL_UPDATE_TRACKER_SESSIONS' => 'Actualizar tabla tracker_sessions',
    'LBL_OOTB_CLEANUP_QUEUE' => 'Limpiar Fila de Trabajos',

    'LBL_FTS_TABLE_TITLE'     => 'Proporcionar configuración de búsqueda de texto completo',
    'LBL_FTS_HOST'     => 'Host',
    'LBL_FTS_PORT'     => 'Puerto',
    'LBL_FTS_TYPE'     => 'Tipo de Motor de Búsqueda',
    'LBL_FTS_HELP'      => 'Para habilitar la búsqueda de texto completo, seleccione el tipo de motor de búsqueda e indique el Host y el Puerto donde se encuentra el motor de búsqueda. Sugar incluye ayuda incorporada para el motor Elastic Search',
    'LBL_FTS_REQUIRED'    => 'Búsqueda elástica es requerida',
    'LBL_FTS_ERROR'    => 'No se puede conectar al servidor de búsqueda de texto, por favor, compruebe la configuración.',
    ...
    'advanced_password_new_account_email' => array(
        ...
        'txt_body' =>
'Aquí dispones de tu nombre de usuario y una contraseña temporal:<br />Nombre de usuario : $contact_user_user_name<br />Contraseña : $contact_user_user_hash<br /><br />$config_site_url<br /><br />Después de registrarte en el sistema con esta contraseña temporal, estarás obligado a poner una nueva contraseña.',
    ...
    'advanced_password_forgot_password_email' => array(
        ...
        'txt_body' =>
'Recientemente a solicitado en $contact_user_pwd_last_changed poder recuperar la contraseña de la cuenta.<br /><br />Clica en el siguiente enlace para restablecer la contraseña:<br /><br />$contact_user_link_guid',
        'name' => 'Olvidaste tu Contraseña de Correo Electrónico',
        ),
);

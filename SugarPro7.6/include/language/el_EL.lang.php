...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'Campaigns'=>'Εκστρατεία',
    'CampaignTrackers'=>'Εκστρατεία Tracker',
    'Documents'=>'Έγγραφο',
...
$app_strings = array (
  ...
  'LBL_ADVANCEDSEARCH' => 'Σύνθετη Αναζήτηση' /*for 508 compliance fix*/,
  ...
  'LBL_JS_CALENDAR' => 'Ημερολόγιο' /*for 508 compliance fix*/,
    ...
    'LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS'     => 'Προεπιλογές Προπληρωμής Gmail™',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPAUTH_REQ'       => 'Πιστοποίηση Χρήσης SMTP;',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPUSER'           => 'Όνομα Χρήστη SMTP',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR'     => 'Διεύθυνση Email',
    ...
    'LBL_EMAIL_ADDRESSES'                   => 'Οποιοδήποτε Email',
    'LBL_EMAIL_ADDRESS_PRIMARY'             => 'Διεύθυνση Email',
    'LBL_EMAIL_ADDRESSES_TITLE'             => 'Διευθύνσεις Email',
    'LBL_EMAIL_ARCHIVE_TO_SUGAR'            => 'Εισαγωγή Email στο Sugar',
    'LBL_EMAIL_ASSIGNMENT'                  => 'Ανάθεση',
    ...
    'LBL_EMAIL_CHECK'                       => 'Έλεγχος Αλληλογραφίας',
    ...
    'LBL_EMAIL_COMPOSE'                     => 'Οποιοδήποτε Email',
  ...
  'LBL_EMAIL_DATE_RECEIVED'               => 'Ημερομηνία Παραλαβής',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC'           => 'Δεν έχετε πρόσβαση σε αυτή την περιοχή. Επικοινωνήστε με τον διαχειριστή του διαδικτύου σας, για να αποκτήσετε πρόσβαση.',
    ...
    'LBL_EMAIL_ERROR_GENERAL_TITLE'         => 'Παρουσιάστηκε λάθος',
    ...
    'LBL_EMAIL_IMPORT_EMAIL'                => 'Εισαγωγή Email στο Sugar',
    ...
    'LBL_EMAIL_SETTINGS_SHOW_IN_FOLDERS'    => 'Ενεργός',
    ...
    'LBL_EMAIL_SETTINGS_TOGGLE_ADV'         => 'Σύνθετη Προβολή',
    'LBL_EMAIL_SETTINGS_USER_FOLDERS'       => 'Διαθέσιμοι Φάκελοι Χειριστών',
    'LBL_EMAIL_ERROR_PREPEND'               => 'Σφάλμα:',
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'ERR_NO_PRIMARY_TEAM_SPECIFIED' => 'Καμία Βασική Ομάδα που διευκρινίζεται',
    ...
    'LBL_CLOSE_BUTTON_KEY'=>'Τ',
    'LBL_CLOSE_WINDOW'=>'Κλείσιμο Παραθύρου',
    'LBL_CLOSEALL_BUTTON_KEY' => 'Τ',
    ...
    'LBL_FILTER_CREATE_NEW' => 'Δημιουργία',
    ...
    'LBL_LAST_VIEWED' => 'Πρόσφατη Προβολή',
    ...
    'LBL_LIST_EMAIL' => 'Οποιοδήποτε Email',
    'LBL_LIST_NAME' => 'Όνομα',
    'LBL_LIST_OF' => 'από',
    ...
    'TPL_MASSADDTOLIST_WARNING_INCOMPLETE' => 'Η Μαζική Προσθήκη στην Λίστα Στόχων απέτυχε. {{num}} εγγραφές δεν προστέθηκαν.',
    ...
    'LBL_LISTVIEW_SELECT_AND_EDIT' => 'Επιλογή',
    ...
    'LBL_FORECAST_WORKSHEETS' => 'Πρόβλεψη Φύλλου Εργασίας',
    ...
    'LBL_EMAIL_DONE_BUTTON_LABEL' => 'Έτοιμο',
    ...
    'LBL_ACCESSKEY_CLEAR_COLLECTION_TITLE' => 'Εκκαθάριση Επιλογής',
    ...
    'LBL_ACCESSKEY_CLEAR_TEAMS_LABEL' => 'Εκκαθάριση Ομάδας',
    ...
    'LBL_LOGIN_USERNAME' => 'Όνομα Χειριστή',
    ...
    'LNK_VIEW_CHANGE_LOG' => 'Προβολή Αλλαγής Καταγραφής',
    ...
    'LBL_OC_DEFAULT_STATUS' => 'Ανενεργός',
    ...
    'LBL_CREATE_NOTE' => 'Δημιουργία Σημείωσης ή Επισύναψης',
  ...
  'LBL_ALT_ADDRESS' => 'Άλλη Διεύθυνση:',
    ...
    'LBL_DASHLET_MINIMIZE_ALL' => 'Κλείσιμο Όλων',
    'LBL_DASHLET_MAXIMIZE_ALL' => 'Άνοιγμα Όλων',
    'LBL_DASHLET_MINIMIZE' => 'Κλείσιμο',
    ...
    'LBL_DASHLET_ATTACHMENTS_NAME' => 'Σημειώσεις & Επισυνάψεις',
    ...
    'LBL_DNB_PRIMARY' => 'Κύρια Διεύθυνση Email',
    ...
    'LBL_DNB_CONTACT' => 'D&B: Πληροφορίες Επαφής',
    ...
    'LBL_DNB_CONTACT_TO' => 'Προς',
    'LBL_DNB_CONTACT_EMAIL' => 'Οποιοδήποτε Email',
    ...
    'LBL_DNB_FAMILY_TREE_MEMBER_ROLE' => 'Ρόλος Κειμένου Μέλους Οικογενειακού Δένδρου',
  ...
  'LBL_COLLECTION_PRIMARY' => 'Κύρια Διεύθυνση Email',
  ...
  'ERR_FILE_NOT_FOUND' => 'Λάθος: Δεν μπόρεσε να φορτώσει το αρχείο {0}. Παρακαλώ ελέγξτε το σύστημα και τα δικαιώματα διαδικτύου του διακομιστή.',
    ...
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Αντιγραφή',
    ...
    'LBL_CONFIRM_BUTTON_LABEL' => 'Επιβεβαίωση:',
    ...
    'LBL_LISTVIEW_NO_RECORDS' => 'Δεν βρέθηκαν εγγραφές.',
    ...
    'LBL_MERGE_DUPLICATES_CONFIRM' => 'Αυτή η ενέργεια θα διαγράψει την ακόλουθη εγγραφή(ές):',
    ...
    'LBL_YES' => 'Ναι',
    'LBL_NO' => 'Όχι',
    'LBL_CALL_BUTTON' => 'Κλήση',
    'LBL_SMS_BUTTON' => 'SMS',
    'LBL_EMAIL_BUTTON' => 'Οποιοδήποτε Email',
    ...
    'LBL_EMAIL_ACTION_SET_PRIMARY' => 'Κύρια Διεύθυνση Email',
    ...
    'ERR_SYNC_FAILED' => 'Ανίκανο να συγχρονιστεί με τον διακομιστή. Προσπάθεια ξανά;',
    ...
    'LBL_WIZ_USER_PROFILE_TITLE' => 'Πληροφορίες Χρήστη',
    ...
    'LBL_WIZ_EMAIL' => 'Οποιοδήποτε Email',
    'LBL_WIZ_TIMEZONE' => 'Ώρα:',
    ...
    'LBL_WIZ_EMAIL_SETTINGS' => 'Επιλογές Email',
    ...
    'LBL_CURRENT_PASSWORD'				=> 'Παλαιός Κωδικός Πρόσβασης:',
    ...
    'LBL_MESSAGE_BOX_TITLE' => 'Προειδοποίηση',
    ...
    'LBL_HISTORY_DASHLET_EMAIL_SINGULAR' => 'Οποιοδήποτε Email',
    ...
    'LBL_ACTIVE_TASKS_DASHLET_COMPLETE_TASK' => 'Ολοκληρωμένη',
    ...
    'LBL_INACTIVE_TASKS_DASHLET_COMPLETED' => 'Ολοκληρωμένη',
    ...
    'LBL_CHART' => 'Γράφημα',
    'LBL_CHART_NO_DATA' => 'Δεν βρέθηκαν εγγραφές.',
    ...
    'LBL_TOP10_OPPORTUNITIES_MY_OPP' => 'Ιστορικό Μου',
    ...
    'LBL_ACTIVITY_STREAM' => 'Δραστηριότητες',
    ...
    'LBL_AMOUNT_USDOLLAR' => 'Συνολικό Ποσό',
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" να οριστικοποιήσει τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.
 ...
 - Επιλέξτε "Αποθήκευση και δημιουργία νέας" για να δημιουργήσει αμέσως μία νέα εγγραφή {{module_name}}.',
    ...
    'LBL_MISSING_SMPT_SERVER_SETTINGS_NOTIFICATION_LINK_TEXT' => 'Επιλογές Email',
